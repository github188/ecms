...
!function (a) {
    "function" == typeof window.define ? window.define.amd ? window.define("wangEditor", ["jquery"], a) : window.define.cmd ? window.define(function (b, c, d) {
        return a
    }) : a(window.jQuery) : "object" == typeof module && "object" == typeof module.exports ? module.exports = a(require("./wangEditor-jquery.js")) : a(window.jQuery)
}(function (a) {
    ...
    return function (a, b) {
        ...
        function c(a, b) {
            var c = b.val, d = a.txt.$txt.html();
            null != c && c !== d && (a.txt.$txt.html(c), a.updateValue())
        }

        var d = [], e = [], f = 20;
        a.fn.undoRecord = function () {
            var a = this, b = a.txt.$txt, c = b.html(), g = e.length ? e[0] : "";
            c !== g && (d.length && (d = []), e.unshift({range: a.currentRange(), val: c}), e.length > f && e.pop())
        }, a.fn.undo = function () {
            if (e.length) {
                var a = e.shift();
        ...
        c.fn.init = function () {
            ...
            function a(e) {
                if (e && e.nodeType && e.nodeName) {
                    ...
                    if (3 === i || 1 === i) {
                        ...
                        if (j.indexOf(h) >= 0)g += c(e); else if (3 === i)g += "<p>" + e.textContent + "</p>"; else {
            ...
            h.on("paste", function (c) {
                if (f.config.pasteFilter) {
                    ...
                    if ("TD" !== d && "TH" !== d) {
                        g = "";
                        var e, h, i = c.clipboardData || c.originalEvent.clipboardData;
                        if (i && i.getData)e = i.getData("text/html"), e ? (h = b("<div>" + e + "</div>"), a(h.get(0))) : (e = i.getData("text/plain"), e && (e = e.replace(/[ ]/g, "&nbsp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\n/g, "</p><p>"), g = "<p>" + e + "</p>", g = g.replace(/<p>(https?:\/\/.*?)<\/p>/gi, function (a, b) {
        ...
        c.fn.render = function () {
            ...
            var d = this.editor, e = d.menuContainer.$menuContainer, f = this.$txt, g = b("<div>");
            if (window.getComputedStyle && "max-height"in window.getComputedStyle(f.get(0))) {
                var h = parseInt(d.$valueContainer.css("max-height"));
                if (isNaN(h))return;
                d.useMaxHeight = !0, g.css({"max-height": h - c + "px", "overflow-y": "auto"}), f.css({
                    height: "auto",
                    "overflow-y": "visible",
                    "min-height": a + "px"
        ...
        a.createMenu(function (c) {
            function d() {
                var a = i.$codeTextarea, b = g.txt.$txt, c = a.val();
        ...
        a.createMenu(function (b) {
            ...
            if (b(c)) {
                ...
                f.dropList = new a.DropList(d, f, {data: g, tpl: h}), f.updateSelectedEvent = function () {
                    var a = d.getRangeElem();
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                }), j.dropPanel = new a.DropPanel(h, j, {$content: k, width: 181}), h.menus[d] = j
            }
        })
    }), b(function (a, b) {
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                b.each(g, function (a, c) {
                    ...
                    k.append(h), b.each(f, function (a, c) {
                        ...
                        f.css({width: e + "px", height: e + "px"}), f.attr("_src", c), d.append(f), h.append(d)
                    }), g.click(function (a) {
                ...
                }), h.dropPanel = new a.DropPanel(e, h, {$content: i, width: 350}), h.clickEvent = function (c) {
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                }), h.dropPanel = new a.DropPanel(e, h, {$content: k, width: 400}), e.menus[d] = h
            }
        })
    }), b(function (a, b) {
        var c = function (a) {
        ...
        a.createMenu(function (e) {
            ...
            if (e(g)) {
                ...
                l.markers = [], l.mapContainerId = "map" + a.random(), l.clearLocations = function () {
                    ...
                    var a = l.map;
                    if (a) {
                        var b, c, d = window.BMap, e = q.val(), f = r.val();
                ...
                var n = new a.Menu({editor: h, id: g, title: j.location});
                h.menus[g] = n;
                var o = b("<div></div>"), p = b('<div style="margin:10px 0;"></div>'), q = b('<input type="text"/>');
                q.css({width: "80px", "text-align": "center"});
                var r = b('<input type="text"/>');
                r.css({width: "300px", "margin-left": "10px"}).attr("placeholder", j.searchlocation);
                ...
                var v = b('<div style="margin:10px 0;"></div>'), w = b('<button class="right">' + j.submit + "</button>"), x = b('<button class="right gray">' + j.cancel + "</button>"), y = b('<label style="display:inline-block;margin-top:10px;color:#666;"></label>'), z = b('<input type="checkbox">');
                y.append(z).append('<span style="display:inline-block;margin-left:5px;">  ' + j.dynamicMap + "</span>"), v.append(y).append(w).append(x), o.append(v), x.click(function (a) {
                    ...
                    a.preventDefault();
                    var c, d, e, g = l.map, i = z.is(":checked"), k = l.markers, m = g.getCenter(), n = m.lng, o = m.lat, p = g.getZoom(), q = g.getSize(), r = q.width, s = q.height;
                ...
                }), n.dropPanel = new a.DropPanel(h, n, {$content: o, width: 500}), n.onRender = function () {
        ...
        a.plugin(function () {
            ...
            c.onload || (c.onload = function (b, c) {
                ...
                0 === b.indexOf("error|") ? (a.warn("上传失败：" + b.split("|")[1]), alert(b.split("|")[1])) : (a.log("上传成功，即将插入编辑区域，结果为：" + b), d = document.createElement("img"), d.onload = function () {
                    var c = '<img src="' + b + '" style="max-width:100%;"/>';
        ...
        window.FileReader && window.FormData && a.plugin(function () {
            ...
            function c(b, c) {
                ...
                d.onload = function () {
                    ...
                    e.command(c, "insertHtml", f), a.log("已插入图片，地址 " + b), d = null
                }, d.onerror = function () {
                    a.error("使用返回的结果获取图片，发生错误。请确认以下结果是否正确：" + b), d = null
                }, d.src = b
            }
            ...
            function d(a) {
                if (a.lengthComputable) {
                    ...
                    e.showUploadProgress(100 * b)
                }
            }

            var e = this, f = e.config, g = f.uploadImgUrl, h = f.uploadTimeout, i = f.uploadImgFns, j = i.onload, k = i.ontimeout, l = i.onerror;
            g && (e.xhrUploadImg = function (f) {
                function i() {
                    u && clearTimeout(u), v && v.abort && v.abort(), m.preventDefault(), s && s.call(e, v), e.hideUploadProgress()
                }

                var m = f.event, n = f.base64, o = f.fileType || "image/png", p = f.name || "wangEditor_upload_file", q = f.loadfn || j, r = f.errorfn || l, s = f.timeoutfn || k, t = "png";
                if (o.indexOf("/") > 0 && o.split("/")[1] && (t = o.split("/")[1]), a.isOnWebsite)return a.log("预览模拟上传"), void c(n, m);
                var u, v = new XMLHttpRequest, w = new FormData;
                v.onload = function () {
                    u && clearTimeout(u), q && q.call(e, v.responseText, v), e.hideUploadProgress()
                }, v.onerror = function () {
                    u && clearTimeout(u), m.preventDefault(), r && r.call(e, v), e.hideUploadProgress()
                }, v.upload.onprogress = d, w.append(p, b(n, o), a.random() + "." + t), v.open("POST", g, !0), v.send(w), u = setTimeout(i, h), a.log("开始上传...并开始超时计算")
            })
        })
    }), b(function (a, b) {
        a.plugin(function () {
        ...
        if (window.FileReader && window.FormData) {
            ...
            c.fn = c.prototype, c.fn.clear = function () {
                ...
                var d = this, e = d.editor, f = b.name || "", g = b.type || "", h = e.config.uploadImgFns, i = h.onload, j = h.ontimeout, k = h.onerror, l = new FileReader;
                return i && j && k ? (a.log("开始执行 " + f + " 文件的上传"), l.onload = function (b) {
                    a.log("已读取" + f + "文件");
                ...
                }, void l.readAsDataURL(b)) : void a.error("请为编辑器配置上传图片的 onload ontimeout onerror 回调事件")
            }, a.UploadFile = c
        }
    }), b(function (a, b) {
        if (!window.FileReader || !window.FormData) {
            ...
            c.fn = c.prototype, c.fn.clear = function () {
                ...
                var c = this, d = c.editor;
                if (!c._hasRender) {
                    var e = c.uploadUrl;
                    a.log("渲染dom");
                    var f = "iframe" + a.random(), g = b('<iframe name="' + f + '" id="' + f + '" frameborder="0" width="0" height="0"></iframe>'), h = c.multiple, i = h ? 'multiple="multiple"' : "", j = b("<p>选择图片并上传</p>"), k = b('<input type="file" ' + i + ' name="wangEditorFormFile"/>'), l = b('<input type="submit" value="上传"/>'), m = b('<form enctype="multipart/form-data" method="post" action="' + e + '" target="' + f + '"></form>'), n = b('<div style="margin:10px 20px;"></div>');
                    m.append(j).append(k).append(l), n.append(m), n.append(g), c.$input = k, c.$iframe = g;
                    var o = new a.Modal(d, void 0, {$content: n});
                    c.modal = o, c._hasRender = !0
                }
            }, c.fn.bindLoadEvent = function () {
                function a() {
                    var a = b.trim(g.document.body.innerHTML);
                    a && (h(a), c.clear(), c.hideModal())
                }
        ...
        a.plugin(function () {
            function c() {
                ...
                a.log("粘贴后，检查到编辑器有" + g.length + "个图片。开始遍历图片，试图找到刚刚粘贴过来的图片"), b.each(g, function () {
                    var g, h, i = this, j = b(i), k = j.attr("src");
                    e.each(function () {
                        return i === this ? (g = !0, !1) : void 0
                    }), g || (a.log("找到一个粘贴过来的图片"), c.test(k) ? (a.log("src 是 base64 格式，可以上传"), h = k.match(c)[1], f.xhrUploadImg({
                        event: d,
                        base64: k,
                        fileType: h,
                        name: "wangEditorPasteFile"
                    })) : a.log("src 为 " + k + " ，不是 base64 格式，暂时不支持上传"), j.remove())
                }), a.log("遍历结束")
            }
            ...
            j && h.on("paste", function (g) {
                d = g;
                var i, j, k = d.clipboardData || d.originalEvent.clipboardData;
                i = null == k ? window.clipboardData && window.clipboardData.getData("text") : k.getData("text/plain") || k.getData("text/html"), i || (j = k && k.items, j ? (a.log("通过 data.items 得到了数据"), b.each(j, function (b, c) {
                    var e = c.type || "";
                    if (!(e.indexOf("image") < 0)) {
                        ...
                        a.log("得到一个粘贴图片"), h.onload = function (b) {
                            ...
                            f.xhrUploadImg({event: d, base64: c, fileType: e, name: "wangEditorPasteFile"})
                        }, h.readAsDataURL(g)
                    }
                ...
                f && f.length && b.each(f, function (b, e) {
                    ...
                    if (!(f.indexOf("image/") < 0)) {
                        ...
                        h.onload = function (b) {
                            ...
                            c.xhrUploadImg({event: d, base64: e, fileType: f, name: "wangEditorDragFile"})
                        }, h.readAsDataURL(e)
                    }
                })
            }))
        ...
        a.plugin(function () {
            ...
            k.on("click", "table", function (a) {
                ...
                setTimeout(f, 100)
            }), a.$body.on("click keypress scroll", function (a) {
                setTimeout(f, 100)
            })
        })
    }), b(function (a, b) {
        a.userAgent.indexOf("MSIE 8") > 0 || a.plugin(function () {
            function c() {
                n || (d(), e(), p.append(q).append(r).append(s).append(t).append(u).append(v).append(w), j.$editorContainer.append(p).append(o), n = !0)
            }
            ...
            function d() {
                ...
                r.click(function (c) {
                    ...
                    b = function () {
                        ...
                        b = 1.1 * b, c = 1.1 * c, i.css({width: b + "px", height: c + "px"})
                    }, a(c, function () {
                        setTimeout(f)
                    })
                }), s.click(function (c) {
                    b = function () {
                        var a = i.get(0), b = a.width, c = a.height;
                        b = .9 * b, c = .9 * c, i.css({width: b + "px", height: c + "px"})
                    }, a(c, function () {
                        setTimeout(f)
                    })
                }), u.click(function (c) {
                    b = function () {
                        i.parent().css({"text-align": "left"}).attr("align", "left")
                    }, a(c, function () {
                        setTimeout(g, 100)
                    })
                }), w.click(function (c) {
                    b = function () {
                        i.parent().css({"text-align": "right"}).attr("align", "right")
                    }, a(c, function () {
                        setTimeout(g, 100)
                    })
                }), v.click(function (c) {
                    b = function () {
                        i.parent().css({"text-align": "center"}).attr("align", "center")
                    }, a(c, function () {
                        setTimeout(g, 100)
                    })
                })
            ...
            function e() {
                function b(a) {
                    ...
                    var k = e + b, l = f + g;
                    o.css({"margin-left": k, "margin-top": l});
                    var m = h + b, n = j + g;
                    i && i.css({width: m, height: n})
                }

                var c, d, e, f, h, j;
                o.on("mousedown", function (k) {
                    i && (c = k.pageX, d = k.pageY, e = parseFloat(o.css("margin-left"), 10), f = parseFloat(o.css("margin-top"), 10), h = i.width(), j = i.height(), p.hide(), a.$document.on("mousemove._dragResizeImg", b), a.$document.on("mouseup._dragResizeImg", function (b) {
                        a.$document.off("mousemove._dragResizeImg"), a.$document.off("mouseup._dragResizeImg"), g(), o.css({
                            "margin-left": e,
                            "margin-top": f
                        }), x = !1
                    }), x = !0)
            ...
            function f() {
                if (!j._disabled && null != i) {
                    i.addClass("clicked");
                    var a = i.position(), b = a.top, c = a.left, d = i.outerHeight(), e = i.outerWidth();
                    o.css({top: b + d, left: c + e});
                    var f = b + d, g = c, h = 0, k = m.position().top, l = m.outerHeight();
                    f > k + l ? f = k + l : o.show(), p.show();
                    var n = p.outerWidth();
                    h = e / 2 - n / 2, p.css({
                        top: f + 5,
                        left: g,
                        "margin-left": h
                    }), 0 > h ? (p.css("margin-left", "0"), q.hide()) : q.show(), j.disableMenusExcept()
                }
            }

            function g() {
                null != i && (i.removeClass("clicked"), i = null, p.hide(), o.hide(), j.enableMenusExcept())
            }

            function h(a) {
                var c = !1;
                return b.each(y, function (d, e) {
                    var f = !1;
                    return b.each(e.imgs, function (b, d) {
                        return a === d ? (c = !0, f = !0, !1) : void 0
                    }), f ? !1 : void 0
                }), c
            }

            var i, j = this, k = j.txt, l = k.$txt, m = j.useMaxHeight ? l.parent() : l, n = (j.$editorContainer, !1), o = b('<div class="img-drag-point"></div>'), p = b('<div class="txt-toolbar"></div>'), q = b('<div class="tip-triangle"></div>'), r = b('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'), s = b('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'), t = b('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>'), u = b('<a href="#"><i class="wangeditor-menu-img-align-left"></i></a>'), v = b('<a href="#"><i class="wangeditor-menu-img-align-center"></i></a>'), w = b('<a href="#"><i class="wangeditor-menu-img-align-right"></i></a>'), x = !1, y = j.config.emotions;
            m.on("mousedown", "img", function (a) {
                a.preventDefault()
            }).on("click", "img", function (a) {
                var d = b(a.currentTarget), e = d.attr("src");
                if (e && !h(e)) {
                    if (c(), i && i.get(0) === d.get(0))return void setTimeout(g, 100);
                    i = d, f(), a.preventDefault(), a.stopPropagation()
                }
            }).on("click keypress scroll", function (a) {
                x || setTimeout(g, 100)
            })
        ...
        a.plugin(function () {
            ...
            if (c !== !1 && "number" == typeof c) {
                ...
                isNaN(d) && (d = 0);
                var e, f = b.$editorContainer, g = f.offset().top, h = f.outerHeight(), i = b.menuContainer.$menuContainer, j = i.css("position"), k = i.css("top"), l = i.outerHeight(), m = i.offset().top;
                b.txt.$txt;
                a.$window.scroll(function () {
                    if (!b.isFullScreen) {
                        e = i.width();
                        ...
                        f >= m && g + h > f + c + l + 30 ? (i.css({
                            position: "fixed",
                            top: c
                        }), i.width(e), a.$body.css({"margin-top": d + l}), b._isMenufixed || (b._isMenufixed = !0)) : (i.css({
                            position: j,
                            top: k
                        }), i.css("width", "100%"), a.$body.css({"margin-top": d}), b._isMenufixed && (b._isMenufixed = !1))
                    }
                })
            }
        })
        ...
        a.plugin(function () {
            ...
            if (d) {
                ...
                var f = b('<a href="#" class="upload-icon-container"><i class="wangeditor-menu-img-upload"></i></a>');
                e.append(f);
