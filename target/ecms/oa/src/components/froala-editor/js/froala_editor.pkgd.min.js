...
!(function(a) {
      ...
      if (
        ...
        for (var c in this.shared)
          this.shared.hasOwnProperty(c) &&
            (this.shared[c], (a.FE.SHARED[this.sid][c] = null));
  ...
  if (
    ...
    (a.FE.LinkRegExHTTP =
      "((ftp|http|https):\\/\\/" + a.FE.LinkRegExCommon + ")"),
    (a.FE.LinkRegExAuth =
      "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" +
      a.FE.LinkRegExCommon +
      ")"),
    (a.FE.LinkRegExWWW =
      "(www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})"),
    (a.FE.LinkRegEx =
      "(" +
      a.FE.LinkRegExTLD +
      "|" +
    ...
    (a.FE.MODULES.helpers = function(b) {
      ...
      function n(b) {
        return (
          ...
          ((b = String(b)
            ...
            .replace(/"/g, "%22")
            .replace(/ /g, "%20")),
          new RegExp("^" + a.FE.LinkRegEx + "$", "gi").test(b))
        );
      }
      function o(b) {
        if (/^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(b))
          return b;
      ...
      function t() {
        return (
          null == z &&
            (z = navigator.platform.toUpperCase().indexOf("MAC") >= 0),
          z
        );
      }
      function u() {
      ...
      function v() {
        return b.o_win.pageYOffset
          ...
          : b.o_doc.documentElement && b.o_doc.documentElement.scrollTop
            ...
            : b.o_doc.body.scrollTop ? b.o_doc.body.scrollTop : 0;
      }
      function w() {
        return b.o_win.pageXOffset
          ...
          : b.o_doc.documentElement && b.o_doc.documentElement.scrollLeft
            ...
            : b.o_doc.body.scrollLeft ? b.o_doc.body.scrollLeft : 0;
      }
      function x() {
        (b.browser = d()), u();
      }
    ...
    (a.FE.MODULES.events = function(b) {
      ...
      function u() {
        t(D),
          (D = []),
          0 === b.shared.count &&
            (t(b.shared.$_events), (b.shared.$_events = []));
      }
      function v(c, d, e) {
      ...
      function w(c, d, e) {
        if (!b.edit.isDisabled() || e) {
          ...
          if (f)
            for (var h = 0; h < f.length; h++)
              void 0 !== (g = f[h].apply(b, [d])) && (d = g);
          return (
            (g = b.$oel.triggerHandler("froalaEditor." + c, a.merge([b], [d]))),
            void 0 !== g && (d = g),
            d
          );
        }
    ...
    (a.FE.MODULES.node = function(b) {
      ...
      function e(a) {
        return (
          !!a &&
          (a.nodeType == Node.ELEMENT_NODE && "a" == a.tagName.toLowerCase())
        );
      }
      function f(e, f) {
        if (!e) return !0;
      ...
      function j(a) {
        for (
          var b = "", c = i(a), d = Object.keys(c).sort(), e = 0;
          e < d.length;
          e++
        ) {
          var f = d[e],
      ...
      function n(a, c) {
        ...
        for (
          ...
          d = d.previousSibling;
        return (
          !d || (d.nodeType == Node.TEXT_NODE && "" === d.textContent && n(d))
        );
      }
      function o(a, c) {
        void 0 === c && (c = !0);
        for (var d = a.nextSibling; d && c && b.node.hasClass(d, "fr-marker"); )
          d = d.nextSibling;
        return (
          !d || (d.nodeType == Node.TEXT_NODE && "" === d.textContent && o(d))
        );
      }
      function p(b) {
        return (
    ...
    (a.FE.MODULES.markers = function(b) {
        ...
        try {
          ...
          if (!0 === e && !d.collapsed) {
            for (; !b.node.isElement(g.parentNode) && !i; )
              a(g.parentNode).after(g), (i = g.nextSibling);
          ...
          if (!1 === e && !d.collapsed) {
            if (
              ((g = b.$el
                .find('span.fr-marker[data-type="false"][data-id="' + f + '"]')
                .get(0)),
              (i = g.previousSibling) &&
          ...
          var k = b.$el
            .find('span.fr-marker[data-type="' + e + '"][data-id="' + f + '"]')
            .get(0);
      ...
      function f() {
        ...
        if (
          (d ||
            ((d = b.node.blockParent(c)) && "LI" != d.tagName && (d = null)),
          d)
        )
          if (b.node.isBlock(d) && b.node.isEmpty(d))
            "LI" != d.tagName ||
            d.parentNode.firstElementChild != d ||
            b.node.isEmpty(d.parentNode)
              ? a(d).replaceWith('<span class="fr-marker"></span>')
              : a(d).append('<span class="fr-marker"></span>');
          else if (b.cursor.isAtStart(c, d))
            a(d).before('<span class="fr-marker"></span>'), a(c).remove();
          else if (b.cursor.isAtEnd(c, d))
            a(d).after('<span class="fr-marker"></span>'), a(c).remove();
          else {
            var f = c,
              g = "",
              h = "";
            ...
            var i =
              b.node.openTagString(d) + a(d).html() + b.node.closeTagString(d);
            (i = i.replace(
      ...
      function g(a) {
        ...
        } else if (void 0 !== b.doc.body.createTextRange)
          try {
    ...
    (a.FE.MODULES.selection = function(b) {
      ...
      function f() {
        ...
        try {
          a.removeAllRanges
            ? a.removeAllRanges()
            : a.empty ? a.empty() : a.clear && a.clear();
        } catch (b) {}
      }
      function g() {
        var f = d();
          ...
          if (f.rangeCount) {
            ...
            if (
              ...
              !j &&
                ...
                ["BR", "IMG", "HR"].indexOf(i.childNodes[0].tagName) < 0 &&
                (i = i.childNodes[0]);
            }
              ...
              a(i.childNodes[h.endOffset]).text() === c()
                ...
                : !h.collapsed &&
                  ...
                  : !h.collapsed &&
                    i.childNodes.length > 0 &&
                    i.childNodes[h.endOffset] &&
                    ((g = i.childNodes[h.endOffset].previousSibling),
                ...
                !j &&
                  i.childNodes.length > 0 &&
                  a(i.childNodes[i.childNodes.length - 1]).text() === c() &&
                  ["BR", "IMG", "HR"].indexOf(
                    i.childNodes[i.childNodes.length - 1].tagName
                  ) < 0 &&
      ...
      function j() {
        ...
        for (c = f.length - 1; c > 0; c--)
          a(f[c]).find(f).length &&
            ("LI" != f[c].tagName ||
              (f[c].children.length > 0 && f.indexOf(f[c].children[0]) >= 0)) &&
            f.splice(c, 1);
        return f;
      }
      function k() {
        if (b.$wp) {
          ...
          for (d = 0; d < f.length; d++)
            if (f[d].startContainer !== b.doc || b.browser.msie) {
              ...
              (void 0 !== i && i) ||
                !h ||
                (a(".fr-marker").remove(), b.selection.setAtEnd(b.el)),
                b.el.normalize(),
                b.browser.safari &&
                  !h &&
                  ((c = b.doc.createRange()),
          ...
          if (b.browser.safari && g.length)
            for (b.selection.clear(), d = 0; d < g.length; d++)
        ...
        for (c = 0; c < e.length; c++) {
          ...
          if (k.length > 0) {
            ...
            try {
              ...
              for (
                var q = k.nextSibling;
                q && q.nodeType == Node.TEXT_NODE && 0 === q.textContent.length;
              ...
              if (i.nextSibling == k || k.nextSibling == i) {
                for (
                  var r = i.nextSibling == k ? i : k,
                    s = r == i ? k : i,
                    t = r.previousSibling;
                  t && t.nodeType == Node.TEXT_NODE && 0 === t.length;
              ...
              if (!o) {
                var w, x;
                (b.browser.chrome || b.browser.edge) && i.nextSibling == k
                  ...
                  : (i.previousSibling == k && ((i = k), (k = i.nextSibling)),
                    (k.nextSibling && "BR" === k.nextSibling.tagName) ||
                      ...
                      (l = a(b.doc.createTextNode("\u200b")))),
                    (w =
                      m(i, j, !0) || (a(i).before(l) && j.setStartBefore(i))),
      ...
      function r(c, d) {
        ...
        c.nodeType == Node.TEXT_NODE
          ? a(c).replaceWith('<span data-first="true" data-text="true"></span>')
        ...
        for (var f = 0; f < e.length; f++) {
          ...
          b.node.hasClass(g, "fr-marker")
            ...
            : d
              ...
              : a(g).find(".fr-marker").length > 0 && (d = t(a(g), d));
        }
        return d;
      }
      function u() {
      ...
      function v() {
        ...
        for (c = 0; c < f.length; c++)
          for (
            var g = f[c];
            !d(g) && !b.node.isBlock(g.parentNode) && !b.$el.is(g.parentNode);
        ...
        for (c = 0; c < h.length; c++) {
          for (
            var i = h[c];
            !e(i) && !b.node.isBlock(i.parentNode) && !b.$el.is(i.parentNode);
                    ...
                    if (null != r || u)
                      if (
                        ...
                        r &&
                          s &&
                          0 === a(r).parentsUntil(b.$el, "table").length &&
                          0 === a(s).parentsUntil(b.$el, "table").length &&
      ...
      function w(c, d) {
        ...
        for (
          ...
          e &&
          (b.node.isBlock(e) ||
            (d && !b.node.isVoid(e) && e.nodeType == Node.ELEMENT_NODE));
      ...
      function y(c, d) {
        ...
        for (
          ...
          e && e.nodeType == Node.TEXT_NODE && 0 === e.textContent.length;
        ...
        return e
          ? (b.node.isBlock(e)
            ...
            !0)
          : !!d && (b.node.isBlock(c) ? w(c) : a(c).before(a.FE.MARKERS), !0);
      }
      function z(c, d) {
        void 0 === d && (d = !0);
        for (
        ...
        return e
          ...
          : !!d && (b.node.isBlock(c) ? x(c) : a(c).after(a.FE.MARKERS), !0);
      }
      return {
        text: c,
        get: d,
    ...
    (a.FE.MODULES.clean = function(b) {
      ...
      function e(a) {
        return (
          ...
          (a = a.replace(
            ...
            function(a) {
              return (
                K.push(a), "[FROALA.EDITOR.NOSCRIPT " + (K.length - 1) + "]"
              );
            }
          )),
          (a = a.replace(
      ...
      function f(a) {
        return (
          ...
          (a = a.replace(/\[FROALA\.EDITOR\.NOSCRIPT ([\d]*)\]/gi, function(
            a,
            c
          ) {
          ...
          (a = a.replace(/\[FROALA\.EDITOR\.IFRAME ([\d]*)\]/gi, function(
            a,
            c
          ) {
            return b.opts.htmlRemoveTags.indexOf("iframe") >= 0
              ? ""
              : K[parseInt(c, 10)]
                  .replace(/\&lt;/g, "<")
                  .replace(/\&gt;/g, ">");
      ...
      function i(a, c, d) {
        if (b.opts.fullPage) {
          ...
          c =
            null == c ? b.html.extractNode(d, "head") || "<title></title>" : c;
          return (
            e +
            "<html" +
            f +
            "><head" +
            h(b.html.extractNodeAttrs(d, "head")) +
            ">" +
            c +
            "</head><body" +
            h(b.html.extractNodeAttrs(d, "body")) +
            ">" +
            a +
            "</body></html>"
          );
        ...
        if (
          ...
          c.nodeType == Node.ELEMENT_NODE &&
            (c.getAttribute("data-fr-src") &&
              ...
              c.setAttribute(
                "data-fr-src",
                b.helpers.sanitizeURL(n(c.getAttribute("data-fr-src")))
              ),
            c.getAttribute("href") &&
              c.setAttribute(
                "href",
                b.helpers.sanitizeURL(n(c.getAttribute("href")))
              ),
            c.getAttribute("src") &&
              c.setAttribute(
                "src",
                b.helpers.sanitizeURL(n(c.getAttribute("src")))
              ),
      ...
      function r(c, d, e, f) {
        ...
        return (
          ...
          (J = b.opts.htmlAllowedStyleProps.length
            ? new RegExp(
                "((^|;|\\s)" +
      ...
      function s() {
        for (
          var c = b.el.querySelectorAll("blockquote + blockquote"), d = 0;
          d < c.length;
          d++
        ) {
          var e = c[d];
      ...
      function u() {
        ...
        if (c)
          for (
            var d = b.el.querySelectorAll("td > " + c + ", th > " + c), e = 0;
            e < d.length;
            e++
          )
      ...
      function z() {
        for (
          var c = b.el.querySelectorAll("ul > ul, ol > ol, ul > ol, ol > ul"),
            d = 0;
          d < c.length;
          d++
        ) {
      ...
      function D() {
        for (var c = b.el.querySelectorAll("ul, ol"), d = 0; d < c.length; d++)
          for (
            var e = b.node.contents(c[d]), f = null, g = e.length - 1;
            g >= 0;
            g--
          )
            "LI" != e[g].tagName
              ? (f || ((f = a("<li>")), f.insertBefore(e[g])), f.prepend(e[g]))
              : (f = null);
      }
      function E() {
        w(), x(), D(), y(), z(), A(), B(), C();
        ...
        if (!b.html.isPreformatted(h)) {
          d &&
            ...
            (f && "BR" !== f.tagName && !b.node.isBlock(f)) ||
              (!b.node.isBlock(h) && !b.node.isLink(h)) ||
              (g = g.replace(/[\f\n\r\t\v ]{1,}$/g, "")),
          ...
          for (var i = "", j = 0; j < g.length; j++)
            32 != g.charCodeAt(j) || (0 !== j && 32 != i.charCodeAt(j - 1))
              ? (i += g[j])
              : (i += a.FE.UNICODE_NBSP);
          (!f ||
            (f && b.node.isBlock(f)) ||
    ...
    (a.FE.MODULES.html = function(b) {
      ...
      function e(c) {
        ...
        for (
          ...
          if (
            !(
              (f[d].textContent &&
                f[d].textContent.replace(/\u200B|\n/g, "").length > 0) ||
              f[d].querySelectorAll(l).length > 0
            )
          ) {
            for (
              var m = b.node.contents(f[d]), n = !1, o = 0;
              o < m.length;
              o++
            )
              if (
      ...
      function h(c) {
        ...
        (d = a.merge(d, b.opts.htmlAllowedEmptyTags)),
          void 0 === c && (d = a.merge(d, a.FE.BLOCK_TAGS));
        var e, f;
        ...
        if ((d && (e = "div"), e)) {
          for (
            ...
            if (
              i.nodeType == Node.ELEMENT_NODE &&
              (b.node.isBlock(i) ||
                (b.opts.htmlDoNotWrapTags.indexOf(i.tagName.toLowerCase()) >=
                  0 &&
      ...
      function l() {
        b.$el.find("div.fr-temp-div").each(function() {
          a(this).attr("data-empty") ||
          ["LI"].indexOf(this.parentNode.tagName) >= 0 ||
      ...
      function o(a) {
        ...
        for (
          ...
          if (!d(e.parentNode, !0)) {
            var f =
                b.node.isBlock(e.parentNode) || b.node.isElement(e.parentNode),
              g = e.textContent
                .replace(/(?!^)( ){2,}(?!$)/g, " ")
                .replace(/\n/g, " ")
                .replace(/^[ ]{2,}/g, " ")
            ...
            if (f) {
              var h = e.previousSibling,
                i = e.nextSibling;
              h && i && " " == g
                ? (g = b.node.isBlock(h) && b.node.isBlock(i) ? "" : "\n")
                : (h || (g = g.replace(/^ */, "")),
                  i || (g = g.replace(/ *$/, "")));
            }
            e.textContent = g;
      ...
      function D(a) {
        if (
          ...
          for (
            var c = a.querySelectorAll('[class=""],[style=""]'), d = 0;
            d < c.length;
            d++
          ) {
            var e = c[d];
              ...
              for (var m = 0, n = k.length; m < n; m++)
                if (k[m].selectorText && k[m].style.cssText.length > 0) {
                  ...
                  for (f = 0; f < o.length; f++) {
                    !o[f].getAttribute("fr-original-style") &&
                    o[f].getAttribute("style")
                      ? (o[f].setAttribute(
                          "fr-original-style",
                          o[f].getAttribute("style")
                        ),
                        g.push(o[f]))
                      : o[f].getAttribute("fr-original-style") || g.push(o[f]),
                      h[o[f]] || (h[o[f]] = {});
                    for (
                      var q = 1e3 * l + C(k[m].selectorText),
          ...
          for (e = 0; e < g.length; e++)
            if (
              ...
              for (f = 0; f < w.length; f++)
                w[f].indexOf(":") > 0 &&
                  (g[e].style[w[f].split(":")[0].trim()] = w[f]
                    .split(":")[1]
                    .trim());
            }
        }
      ...
      function G() {
        var c = function(c, d) {
          ...
          d = function() {
            ...
            return (
              ...
              null != d && (a.inArray(b.el, a(d).parents()) >= 0 || d == b.el)
                ? d
                : null
            );
          },
        ...
        if (void 0 !== b.win.getSelection) {
          ...
          for (var f = b.selection.ranges(), g = 0; g < f.length; g++) {
            ...
            if (i.length) {
              var j = i[i.length - 1];
              (("P" == j.tagName && b.opts.enter == a.FroalaEditor.ENTER_P) ||
                ("DIV" == j.tagName &&
      ...
      function K(c) {
        ...
        d.innerHTML = c;
        for (
          var e = d.querySelectorAll(":scope > " + b.html.defaultTag()),
            f = e.length - 1;
          f >= 0;
          f--
        ) {
          var g = e[f];
          b.node.isBlock(g.previousSibling) ||
            (g.previousSibling &&
              !b.node.isEmpty(g) &&
              a("<br>").insertAfter(g.previousSibling),
            (g.outerHTML = g.innerHTML));
        }
        return d.innerHTML;
      }
      function L(c, d, e) {
        ...
        if (
          ...
          b.core.isEmpty() && !b.opts.keepFormatOnDelete && H(f))
        )
          b.el.innerHTML = f;
        else {
          var g = b.markers.insert();
          if (g) {
            b.node.isLastSibling(g) &&
              a(g)
                .parent()
                .hasClass("fr-deletable") &&
              a(g).insertAfter(a(g).parent());
            var h = b.node.blockParent(g);
            if (
              (H(f) || e) &&
              (b.node.deepestParent(g) || (h && "LI" == h.tagName))
            ) {
              if (("LI" == h.tagName && (f = K(f)), !(g = b.markers.split())))
                return !1;
              g.outerHTML = f;
            } else g.outerHTML = f;
      ...
      function M(c) {
        var d = null;
        if (
          (void 0 === c && (d = b.selection.element()),
          b.opts.keepFormatOnDelete)
        )
          return !1;
        var e = d
    ...
    (a.FE.MODULES.placeholder = function(b) {
      function c() {
        ...
        if (k.length && k[0].nodeType == Node.ELEMENT_NODE) {
          var m = a(k[0]);
          (!b.opts.toolbarInline || b.$el.prev().length > 0) &&
            b.ready &&
            ((d = b.helpers.getPX(m.css("margin-top"))),
        ...
        b.$wp.addClass("show-placeholder"),
          b.$placeholder
            .css({
              marginTop:
                Math.max(b.helpers.getPX(b.$el.css("margin-top")), d) + c,
              paddingTop: Math.max(
      ...
      function d() {
        a.$wp
          ? (a.$el.attr("contenteditable", !1),
            ...
            a.$tb && a.$tb.addClass("fr-disabled").attr("aria-disabled", !0))
      ...
      function e(e) {
        ...
        if (b.node.isEmpty(g, !0) && h) {
          for (
            ...
            !b.node.isList(m) && m.parentNode && "LI" !== m.parentNode.tagName;
          ...
          f = d(g);
          for (
            var r = a.FE.MARKERS + "<br>", s = e.parentNode;
            s && "LI" != s.tagName;
            ...
            f.parentNode && "LI" == f.parentNode.tagName
              ? h
                ? a(f.parentNode).before(
                    b.node.openTagString(g) + a.FE.MARKERS + "<br></li>"
                  )
                : a(f.parentNode).after(
                    b.node.openTagString(g) + a.FE.MARKERS + "<br></li>"
                  )
              : j
                ? a(f).before("<" + j + ">" + a.FE.MARKERS + "<br></" + j + ">")
    ...
    (a.FE.MODULES.cursor = function(b) {
            ...
            if (b.node.isDeletable(h))
              ...
              if (b.node.isBlock(h))
                if (b.node.isEmpty(h) && !b.node.isList(h))
                  a(h).remove(),
                    a(c).after(
                      b.opts.keepFormatOnDelete ? a.FE.INVISIBLE_SPACE : ""
                    );
                else {
                  if (
                    (b.node.isList(h) &&
                    ...
                    for (
                      g = b.node.contents(h);
                      g.length && b.node.isBlock(g[g.length - 1]);
                  ...
                  b.node.isEmpty(e)
                    ? (a(c).remove(),
                      b.selection.setAtEnd(h, b.opts.keepFormatOnDelete))
        ...
        if (!b.node.isBlock(d) && b.node.isEditable(d)) {
          ...
          if (d.nodeType == Node.TEXT_NODE) {
            ...
            if (b.opts.tabSpaces && f.length >= b.opts.tabSpaces) {
              0 ===
                f
                  .substr(f.length - b.opts.tabSpaces, f.length - 1)
                  .replace(/ /g, "")
            ...
            b.node.isDeletable(d)
              ...
              : c.nextSibling &&
                ...
                b.node.isVoid(d) &&
                "BR" != d.tagName
                ? (a(c.nextSibling).remove(), a(c).replaceWith(a.FE.MARKERS))
                : !1 !== b.events.trigger("node.remove", [a(d)]) &&
                  (a(d).after(a.FE.MARKERS), a(d).remove());
        } else if (
      ...
      function k() {
        ...
        for (var l = k.parentNode; l && !b.node.isElement(l); ) {
          if ("false" === l.getAttribute("contenteditable"))
            return a(k).replaceWith(a.FE.MARKERS), b.selection.restore(), !1;
        ...
        if (m) {
          ...
          n &&
            n.length &&
            8203 == n.charCodeAt(n.length - 1) &&
            (1 == n.length
              ? a(m).remove()
              : (m.textContent = m.textContent.substr(0, n.length - h(n))));
        }
        return (
          c(k)
            ? (f = j(k))
          ...
          b.opts.htmlUntouched ||
            (b.html.cleanEmptyTags(), b.clean.quotes(), b.clean.lists()),
        ...
        if (((e = e.nextSibling), "BR" == e.tagName && b.node.isEditable(e)))
          if (e.nextSibling) {
            ...
            if (g(d)) b.cursorLists._del(d);
              ...
              f &&
                ((!b.node.isEmpty(b.node.blockParent(e)) ||
                  (b.node.blockParent(e).nextSibling &&
                    a.FE.NO_DELETE_TAGS.indexOf(
                      b.node.blockParent(e).nextSibling.tagName
                    )) < 0) &&
                  a(e).remove(),
                l(d));
            }
        ...
        if (!b.node.isBlock(e) && b.node.isEditable(e)) {
          ...
          e.nodeType == Node.TEXT_NODE
            ...
            : b.node.isDeletable(e)
              ...
              : !1 !== b.events.trigger("node.remove", [a(e)]) &&
                (a(e).before(a.FE.MARKERS), a(e).remove()),
            a(d).remove();
        } else if (
        ...
        if (i && "BLOCKQUOTE" == i.tagName) {
          if (e(c, i))
            return (
              (h = b.html.defaultTag()),
              h
                ? a(i).before("<" + h + ">" + a.FE.MARKERS + "<br></" + h + ">")
          ...
          if (b.node.isBlock(i))
            if (d) a(c).remove(), a(i).prepend("<br>" + a.FE.MARKERS);
              ...
              if (b.opts.keepFormatOnDelete) {
                for (
                  var j = c, k = a.FE.INVISIBLE_SPACE;
                  j != i && !b.node.isElement(j);

                )
                  (j = j.parentNode),
                    (k =
                      b.node.openTagString(j) + k + b.node.closeTagString(j));
                a(i).before(k);
              } else
                a(i).before(
                  b.node.openTagString(
      ...
      function t(e) {
        ...
        a(f).parentsUntil(b.$el, "BLOCKQUOTE").length > 0 &&
          ...
          c(f)
            ? !g(f) || e || h ? q(f, e, h) : b.cursorLists._endEnter(f)
            : d(f)
              ? !g(f) || e || h ? r(f, e, h) : b.cursorLists._startEnter(f)
              : !g(f) || e || h ? s(f, e, h) : b.cursorLists._middleEnter(f),
          p(),
          b.html.fillEmptyBlocks(!0),
    ...
    (a.FE.MODULES.keys = function(b) {
      ...
      function o(i) {
        ...
        if (
          ((b.selection.isFull() &&
            ...
            (m && b.placeholder.isVisible() && b.opts.keepFormatOnDelete)) &&
          (l || m)
        ) {
          var n = b.html.defaultTag();
          if (
            (n
              ? b.$el.html("<" + n + ">" + a.FE.MARKERS + "<br/></" + n + ">")
              : b.$el.html(a.FE.MARKERS + "<br/>"),
            b.selection.restore(),
            !v(j))
          )
        ...
        j == a.FE.KEYCODE.ENTER
          ? i.shiftKey ? d(i) : c(i)
          : j === a.FE.KEYCODE.BACKSPACE && (i.metaKey || i.ctrlKey)
            ? e()
            : j != a.FE.KEYCODE.BACKSPACE || t(i) || i.altKey
              ? j != a.FE.KEYCODE.DELETE || t(i) || i.altKey || i.shiftKey
                ? j == a.FE.KEYCODE.SPACE
                  ? h(i)
                  : j == a.FE.KEYCODE.TAB
                    ? k(i)
                    : t(i) ||
      ...
      function q() {
        ...
        b.opts.height || b.opts.heightMax
          ? ((c = b.position.getBoundingRect().top),
            (b.helpers.isIOS() || b.helpers.isAndroid()) &&
          ...
          : ((c = b.position.getBoundingRect().top),
            ...
            (b.helpers.isIOS() || b.helpers.isAndroid()) &&
              (c -= b.helpers.scrollTop()),
            b.opts.iframe &&
              ((c += b.$iframe.offset().top), (c -= b.helpers.scrollTop())),
            (c += b.opts.toolbarStickyOffset),
            c > b.o_win.innerHeight - 20 &&
              a(b.o_win).scrollTop(
                c + b.helpers.scrollTop() - b.o_win.innerHeight + 20
              ),
            (c = b.position.getBoundingRect().top),
            b.opts.toolbarBottom || (c -= b.opts.toolbarStickyOffset),
            (b.helpers.isIOS() || b.helpers.isAndroid()) &&
      ...
      function s(c) {
        if (b.helpers.isIOS() && c && G)
          if (c.which == a.FE.KEYCODE.ENTER)
            b.snapshot.restore(G), b.cursor.enter();
        ...
        e(g) &&
          ...
          "IFRAME" != g.tagName &&
          f(g) &&
          (b.selection.save(), p(g), b.selection.restore());
      }
      function t(a) {
      ...
      function w(c) {
        ...
        if (
          ...
          return !0;
        D || ((E = b.snapshot.get()), b.undo.canDo() || b.undo.saveStep()),
          clearTimeout(D),
      ...
      function x(a) {
        ...
        E && D
          ? (b.undo.saveStep(E), (E = null))
          : (void 0 !== c && 0 !== c) || E || D || b.undo.saveStep();
      }
      function y() {
      ...
      function B(c) {
        var d = b.el.childNodes,
          e = b.html.defaultTag();
        return (
          !(!c.target || c.target === b.el) ||
          (0 === d.length ||
            void (b.$el.outerHeight() - c.offsetY <= 10
              ? A(d[d.length - 1]) &&
                (e
                  ? b.$el.append(
                      "<" + e + ">" + a.FE.MARKERS + "<br></" + e + ">"
                    )
                  : b.$el.append(a.FE.MARKERS + "<br>"),
                b.selection.restore(),
                q())
              : c.offsetY <= 10 &&
                A(d[0]) &&
    ...
    (a.FE.MODULES.accessibility = function(b) {
      function c(a) {
        if (a && a.length) {
          ...
          (a.parents(".fr-toolbar, .fr-popup").data("instance") || b).events
            .disableBlur(),
            a.focus(),
            (b.shared.$f_el = a);
        }
      ...
      function e(a) {
        return (
          a.is("input, textarea") && g(), b.events.disableBlur(), a.focus(), !0
        );
      }
      function f(a, c) {
        var d = a
      ...
      function v(c, d) {
        ...
        return (
          f != a.FE.KEYCODE.TAB || e || c.shiftKey || c.altKey
            ? f != a.FE.KEYCODE.ARROW_RIGHT || e || c.shiftKey || c.altKey
              ? f != a.FE.KEYCODE.TAB || e || !c.shiftKey || c.altKey
                ? f != a.FE.KEYCODE.ARROW_LEFT || e || c.shiftKey || c.altKey
                  ? f != a.FE.KEYCODE.ARROW_UP || e || c.shiftKey || c.altKey
                    ? f != a.FE.KEYCODE.ARROW_DOWN ||
                      e ||
                      c.shiftKey ||
                      c.altKey
                      ? f != a.FE.KEYCODE.ENTER || e || c.shiftKey || c.altKey
                        ? f != a.FE.KEYCODE.ESC || e || c.shiftKey || c.altKey
                          ? f != a.FE.KEYCODE.F10 ||
                            e ||
                            c.shiftKey ||
                            !c.altKey ||
              ...
              if (a.FE.KEYCODE.ENTER != j)
                return a.FE.KEYCODE.ESC == j
                  ? (g.preventDefault(),
                    g.stopPropagation(),
                    h(i),
                    i.popups.isVisible(c) && e.find(".fr-back:visible").length
                      ? (i.opts.toolbarInline &&
                          (i.events.disableBlur(), i.events.focus()),
                        i.button.exec(e.find(".fr-back:visible:first")),
                        z(e))
                      : i.popups.isVisible(c) &&
                        e.find(".fr-dismiss:visible").length
                        ? i.button.exec(e.find(".fr-dismiss:visible:first"))
                        : (i.popups.hide(c),
                          i.opts.toolbarInline &&
                  ...
                  : a.FE.KEYCODE.SPACE == j &&
                    (k.is(".fr-submit") || k.is(".fr-dismiss"))
                    ? (g.preventDefault(),
                      g.stopPropagation(),
                      i.events.disableBlur(),
                      i.button.exec(k),
                    ...
                    : i.keys.isBrowserAction(g)
                      ...
                      : k.is("input[type=text], textarea")
                        ? void g.stopPropagation()
                        : a.FE.KEYCODE.SPACE == j &&
                          (k.is(".fr-link-attr") || k.is("input[type=file]"))
                          ? void g.stopPropagation()
                          : (g.stopPropagation(), g.preventDefault(), !1);
              var p = null;
      ...
      function D(c) {
        ...
        if (c.which == a.FE.KEYCODE.F10 && !d && !c.shiftKey && c.altKey) {
          ...
          var e = b.popups.areVisible(b),
            g = !1;
          return (
            e && (g = f(e.children().not(".fr-buttons"))),
            g || k(),
            (b.shared.with_kb = !1),
            c.preventDefault(),
            c.stopPropagation(),
    ...
    (a.FE.MODULES.format = function(b) {
      ...
      function h(h, i) {
        ...
        if (
          ...
          b.$el
            .find(".fr-marker")
            .replaceWith(c(h, i) + a.FE.INVISIBLE_SPACE + a.FE.MARKERS + d(h)),
            b.selection.restore();
        } else {
          b.selection.save();
          g(
          ...
          do {
            for (
              k = b.$el.find(e(h, i) + " > " + e(h, i)), j = 0;
              j < k.length;
              j++
            )
              k[j].outerHTML = k[j].innerHTML;
          } while (k.length);
          b.el.normalize();
          ...
          for (j = 0; j < l.length; j++) {
            var m = a(l[j]);
            !0 === m.data("type")
              ? f(m.get(0).nextSibling, e(h, i)) && m.next().prepend(m)
              : f(m.get(0).previousSibling, e(h, i)) && m.prev().append(m);
          }
          b.selection.restore();
        }
      }
      function i(a, c, d, g) {
        ...
        if (a.parents(c).length || void 0 === c) {
          ...
          for (
            ...
            (void 0 === c || (void 0 !== c && !f(k.get(0), e(c, d))));
            ...
            if (
              (k.attr("data-cloned") ||
                ...
                ((l = k
                  ...
                  .addClass("fr-clone")),
                !0 === k.data("type")
                  ? k.attr("data-cloned", !0).after(l)
                  : k.attr("data-cloned", !0).before(l)),
              i(k, c, d, e))
            ) {
              f = !0;
              break;
          ...
          b.$el.find("span[style] span[style]").each(function() {
            if (
              ...
              b.attr("style").indexOf("background-color") >= 0 &&
                (a(this).attr(
                  "style",
                  a(this).attr("style") + ";" + b.attr("style")
                ),
      ...
      function q(a, c) {
        ...
        if (
          ...
          !d.collapsed &&
            g.nodeType == Node.TEXT_NODE &&
            d.startOffset == (g.textContent || "").length)
        ) {
        ...
        for (
          ...
          i && i.nodeType == Node.ELEMENT_NODE && i != b.el && !f(i, e(a, c));
    ...
    a.extend(a.FE.DEFAULTS, { indentMargin: 20 }),
    (a.FE.COMMANDS = {
      bold: {
        title: "Bold",
        toggle: !0,
      ...
      function d(c, d) {
        if (!1 !== b.events.trigger("commands.before", a.merge([c], d || []))) {
          var e = (a.FE.COMMANDS[c] && a.FE.COMMANDS[c].callback) || i[c],
            ...
            g = !1;
          a.FE.COMMANDS[c] &&
            (void 0 !== a.FE.COMMANDS[c].focus && (f = a.FE.COMMANDS[c].focus),
            void 0 !== a.FE.COMMANDS[c].accessibilityFocus &&
              (g = a.FE.COMMANDS[c].accessibilityFocus)),
            ((!b.core.hasFocus() && f && !b.popups.areVisible()) ||
              (!b.core.hasFocus() && g && b.accessibility.hasFocus())) &&
              b.events.focus(!0),
            a.FE.COMMANDS[c] &&
              !1 !== a.FE.COMMANDS[c].undo &&
      ...
      var i = {
          ...
          insertHR: function() {
            ...
            e.prev().is("hr")
              ...
              f ||
                void 0 === f ||
                ((d = a.FE.MARKERS + "<br>"), (d = c(d)), e.after(d)),
              b.selection.restore();
          },
    ...
    (a.FE.MODULES.data = function(b) {
      ...
      function d(a) {
        ...
        for (
          ...
          for (var j = e(++h), k = a[d](i), l = ""; /[0-9-]/.test(a[i + 1]); )
            l += a[++i];
          (l = parseInt(l, 10) || 0),
            (k = f(k, j, l)),
            (k ^= (h - 1) & 31),
      ...
      function j() {
        ...
        for (var f = 0; f < d.length; f++) {
          ...
          if (
            !(
              g !== o(c(o("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) &&
              g.indexOf(n, g.length - n.length) < 0 &&
              [
                o("9qqG-7amjlwq=="),
                o("KA3B3C2A6D1D5H5H1A3=="),
                o("QzbzvxyB2yA-9m=="),
                o("ji1kacwmgG5bc=="),
                o("naamngiA3dA-16xtE-11C-9B1H-8sc==")
              ].indexOf(n) < 0
            )
          ) {
            b.ul = !1;
    ...
    (a.FE.MODULES.paste = function(b) {
      ...
      function e(a) {
        ...
        if (
          ...
          !1 === b.events.trigger("paste.before", [a]))
        )
          return a.preventDefault(), !1;
        if (
          ((q = b.$win.scrollTop()),
          ...
          if (
            ((r = ""),
            /text\/rtf/.test(c) && (s = a.clipboardData.getData("text/rtf")),
            /text\/html/.test(c)
              ? (r = a.clipboardData.getData("text/html"))
      ...
      function f(c) {
        if (
          ...
          if (
            ((r = ""),
            /text\/rtf/.test(d) && (s = c.dataTransfer.getData("text/rtf")),
            /text\/html/.test(d)
              ? (r = c.dataTransfer.getData("text/html"))
              : /text\/rtf/.test(d) && b.browser.safari
                ? (r = s)
                : /text\/plain/.test(d) &&
      ...
      function g() {
        b.selection.save(),
          ...
          (r = null),
          t
            ? (t.html(""), b.browser.edge && b.opts.iframe && b.$el.append(t))
            : ((t = a(
                '<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%;" tabIndex="-1"></div>'
              )),
              b.browser.safari
                ? (t.css("top", b.$sc.scrollTop()), b.$el.after(t))
      ...
      function j() {
        ...
        c && "string" == typeof c && (r = c),
          (!a || (a && !1 !== b.events.trigger("paste.wordPaste", [r]))) &&
            k(r, a);
      }
      function k(c, d, e) {
        var f,
        ...
        var k = !1;
        if (
          (c.indexOf('id="docs-internal-guid') >= 0 &&
            ((c = c.replace(
          ...
          q &&
            o.textContent.replace(/(\u00A0)/gi, " ").replace(/\r|\n/gi, "") ==
              q
                .replace(/(\u00A0)/gi, " ")
                .replace(/(\r|\n)+([ ]+[\r\n]+)*/gi, " ") &&
            (c = p),
        ...
        if (("string" == typeof r && (c = r), "" !== c)) {
          ...
          if (b.opts.enter == a.FE.ENTER_BR)
            for (
              g = s.querySelectorAll("p, div"), f = g.length - 1;
              f >= 0;
              f--
            )
              (j = g[f]),
                0 === j.attributes.length &&
                  (j.outerHTML =
                    j.innerHTML +
                    (j.nextSibling && !b.node.isEmpty(j) ? "<br>" : ""));
          else if (b.opts.enter == a.FE.ENTER_DIV)
            for (g = s.getElementsByTagName("p"), f = g.length - 1; f >= 0; f--)
              (j = g[f]), (j.outerHTML = "<div>" + j.innerHTML + "</div>");
      ...
      function n(c) {
        ...
        for (
          var f = e.querySelectorAll(
            "*:empty:not(td):not(th):not(iframe):not(svg):not(" +
              a.FE.VOID_ELEMENTS.join("):not(") +
              ")"
          );
          f.length;
        ...
        for (
          ...
          if (b.html.defaultTag() && "div" != b.html.defaultTag())
            h.querySelector(b.html.blockTagsQuery())
            ...
            !i.length ||
            ("BR" !== i[i.length - 1].tagName && 0 === h.innerText.length)
              ? (h.outerHTML = h.innerHTML + "<br>")
              : (h.outerHTML = h.innerHTML);
          }
    ...
    a.extend(a.FE.DEFAULTS, { shortcutsEnabled: [], shortcutsHint: !0 }),
    (a.FE.SHORTCUTS_MAP = {}),
      ...
      function c(c) {
        ...
        if (!f) {
          ...
          for (var d in a.FE.SHORTCUTS_MAP)
            a.FE.SHORTCUTS_MAP.hasOwnProperty(d) &&
              b.opts.shortcutsEnabled.indexOf(a.FE.SHORTCUTS_MAP[d].cmd) >= 0 &&
              (f[
        ...
        return e
          ? (b.helpers.isMac() ? String.fromCharCode(8984) : "Ctrl+") +
            (e.shift
              ? b.helpers.isMac() ? String.fromCharCode(8679) : "Shift+"
              : "") +
            (e.option
              ? b.helpers.isMac() ? String.fromCharCode(8997) : "Alt+"
              : "") +
            e.letter
          : null;
      }
            ...
            if (
              (h && !j
                ...
                : h &&
                  j &&
                  (i = b.$tb.find(
                    '.fr-command[data-cmd="' + h + '"][data-param1="' + j + '"]'
                  )),
              i.length)
            )
              return (
    ...
    (a.FE.MODULES.snapshot = function(a) {
      ...
      function f() {
        ...
        if (
          ...
          (b.html = (a.$wp ? a.$el.html() : a.$oel.get(0).outerHTML).replace(
            / style=""/g,
            ""
          )),
          (b.ranges = []),
      ...
      function i(b) {
        a.$el.html() != b.html &&
          (a.opts.htmlExecuteScripts
            ? a.$el.html(b.html)
            : (a.el.innerHTML = b.html));
    ...
    (a.FE.MODULES.undo = function(a) {
      ...
      function e(b) {
        if (!a.undo_stack || a.undoing || a.el.querySelector(".fr-marker"))
          return !1;
        void 0 === b
          ? ((b = a.snapshot.get()),
      ...
      function k() {
        i(),
          a.events.on("initialized", function() {
            l = (a.$wp ? a.$el.html() : a.$oel.get(0).outerHTML).replace(
              / style=""/g,
              ""
            );
          }),
    ...
    (a.FE.ICON_TEMPLATES = {
      ...
      svg:
        '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">[PATH]</svg>'
    }),
    (a.FE.ICONS = {
      bold: { NAME: "bold" },
      italic: { NAME: "italic" },
    ...
    (a.FE.MODULES.button = function(b) {
      ...
      function e(c) {
        ...
        if (
          (h.helpers.isIOS() &&
            ...
            (h.selection.save(), h.selection.clear(), h.selection.restore()),
          !f)
        ) {
          var i = c.data("cmd");
          e
          ...
          e.removeClass("test-height"),
            ...
            e.offset().top + c.outerHeight() + j < a(b.o_doc).height()
        ...
        c.addClass("fr-blink").toggleClass("fr-active"),
          c.hasClass("fr-active")
            ? (e.attr("aria-hidden", !1), c.attr("aria-expanded", !0))
            : (e.attr("aria-hidden", !0), c.attr("aria-expanded", !1)),
          setTimeout(function() {
            c.removeClass("fr-blink");
          }, 300),
          e.css("margin-left", ""),
          e.offset().left + e.outerWidth() >
            b.$sc.offset().left + b.$sc.width() &&
            e.css(
              "margin-left",
              -(
                e.offset().left +
        ...
        b.helpers.isMobile() ||
          (k.length
            ? b.accessibility.focusToolbarElement(k)
      ...
      function f(a) {
        ...
        for (
          var b = a.data("cmd"), c = [];
          void 0 !== a.data("param" + (c.length + 1));
        ...
        b.node.hasClass(c.get(0), "fr-dropdown")
          ...
          : (g(c),
            a.FE.COMMANDS[c.data("cmd")] &&
              !1 !== a.FE.COMMANDS[c.data("cmd")].refreshAfterCallback &&
      ...
      function m(c, d) {
        ...
        b.events.$on(a(f), b._mouseup + " resize keydown", g, !0),
          ...
          b.node.hasClass(c.get(0), "fr-popup")
            ? a.merge(x, c.find(".fr-btn").toArray())
      ...
      function n(a, c) {
        var d = "";
        if (c.html)
          "function" == typeof c.html ? (d += c.html.call(b)) : (d += c.html);
        else {
          var e = c.options;
      ...
      function o(a, c, d) {
        ...
        if (e) {
          ...
          f =
            ...
            'px">' +
            b.language.translate(g || c.title) +
            "</span>";
        } else
      ...
      function r(c) {
        ...
        setTimeout(function() {
          for (
            var e = d.selection.inEditor() && d.core.hasFocus(), f = 0;
            f < c.length;
            f++
          ) {
            var g = a(c[f]),
      ...
      (b.opts.toolbarInline || b.opts.toolbarContainer) &&
        (b.shared.buttons || (b.shared.buttons = []), (w = b.shared.buttons));
      var x = [];
    ...
    (a.FE.MODULES.modals = function(b) {
      ...
      function d(c, d) {
        ...
        return (
          (e +=
            ...
            '" class="fa fa-times fr-modal-close"></i></div>'),
            ...
            b.events.$on(
              ...
              function(d) {
                ...
                return e == a.FE.KEYCODE.ESC
                  ? (h(c), b.accessibility.focusModalButton(g), !1)
                  : !(
                      !a(d.currentTarget).is("input[type=text], textarea") &&
      ...
      function h(c, d) {
        if (n[c]) {
          ...
          f.events.enableBlur(),
            ...
            d ||
              (b.accessibility.restoreSelection(f),
      ...
      function j(a) {
        ...
        return (
          (c && b.node.hasClass(c, "fr-active") && b.core.sameInstance(c)) || !1
        );
      }
      function k(a) {
        for (var b in n)
          if (
            n.hasOwnProperty(b) &&
            j(b) &&
            (void 0 === a || n[b].$modal.data("instance") == a)
          )
            return n[b].$modal;
        return !1;
      }
      ...
      function d(a, d, e, h) {
        if (
          (g() && b.$el.find(".fr-marker").length > 0
            ? (b.events.disableBlur(), b.selection.restore())
            : (b.events.disableBlur(), b.events.focus(), b.events.enableBlur()),
          m([a]),
          !x[a])
        )
          return !1;
        ...
        b.opts.toolbarInline &&
          ...
          b.opts.toolbarBottom &&
            ...
            b.$tb &&
            l.get(0) == b.$tb.get(0) &&
            (x[a].addClass("fr-above"), e && (e -= x[a].outerHeight())),
      ...
      function s(c) {
        ...
        return {
          ...
          _inputFocus: function(c) {
            ...
            if (
              (f.is("input:file") &&
                f.closest(".fr-layer").addClass("fr-input-focus"),
              c.preventDefault(),
              c.stopPropagation(),
              setTimeout(function() {
                e.events.enableBlur();
          ...
          _inputBlur: function(c) {
            var e = d.data("instance") || b,
              f = a(c.currentTarget);
            f.is("input:file") &&
              f.closest(".fr-layer").removeClass("fr-input-focus"),
          ...
          _editorKeydown: function(e) {
            ...
            g.keys.ctrlKey(e) ||
              ...
              (f(c) && d.find(".fr-back:visible").length
                ...
                : e.which != a.FE.KEYCODE.ALT && g.popups.hide(c));
          },
          _preventFocus: function(c) {
            ...
            "mouseup" == c.type || a(f).is(":focus") || e.events.disableBlur(),
              "mouseup" != c.type ||
                a(f).hasClass("fr-command") ||
                a(f).parents(".fr-command").length > 0 ||
                b.button.hideActiveDropdowns(d),
              (b.browser.safari || b.browser.mozilla) &&
                "mousedown" == c.type &&
                a(f).is("input[type=file]") &&
                e.events.disableBlur();
            var g = "input, textarea, button, select, label, .fr-command";
            if (f && !a(f).is(g) && 0 === a(f).parents(g).length)
          ...
          _windowMouseup: function(a) {
            ...
            d.is(":visible") &&
              p() &&
              (a.stopPropagation(), e.markers.remove(), e.popups.hide(c), o());
          },
                ...
                return (
                  ...
                  f.popups.isVisible(c) &&
                    (d.find(".fr-back:visible").length
                      ? (f.button.exec(d.find(".fr-back:visible:first")),
                        f.accessibility.focusPopupButton(d))
                      : d.find(".fr-dismiss:visible").length
                        ? f.button.exec(d.find(".fr-dismiss:visible:first"))
                        : (f.popups.hide(c),
              ...
              if (f.popups.isVisible(c))
                return (
                  d.find(".fr-back:visible").length
                    ...
                    : d.find(".fr-dismiss:visible").length
                      ? f.button.exec(d.find(".fr-dismiss:visible:first"))
                      : (f.popups.hide(c), f.accessibility.focusPopupButton(d)),
                  !1
                );
            }
          },
          _doPlaceholder: function() {
            0 === a(this).next().length &&
          ...
          b.events.on(
            ...
            function() {
              b.core.sameInstance(x[c]) &&
                x[c].removeClass("fr-active").appendTo("body:first");
            },
            !0
          );
      }
    ...
    (a.FE.MODULES.position = function(b) {
      function c() {
        ...
        if ((0 === c.top && 0 === c.left && 0 === c.width) || 0 === c.height) {
          ...
          e.css("display", "none"),
            ...
            (c.height = g),
            (c.top =
              f.top - (b.helpers.isMobile() ? 0 : b.helpers.scrollTop())),
            (c.right = 1),
            (c.bottom = 1),
            (c.ok = !0),
            d && b.selection.restore();
      ...
      function e(a, c) {
        ...
        return (
          a.parent().offset().left + c + d >
            b.$sc.get(0).clientWidth - b.$sc.position().left - 10 &&
            (c = b.$sc.get(0).clientWidth - a.parent().offset().left - d - 10),
          c < 0 && (c = 10),
          c
        );
      }
      ...
      function g(a, c, f, g) {
        ...
        !h ||
          ("BODY" === h.get(0).tagName && "static" == h.css("position")) ||
          (a && (a -= h.offset().left),
          c && (c -= h.offset().top),
          "BODY" != h.get(0).tagName
            ? (a && (a += h.get(0).scrollLeft), c && (c += h.get(0).scrollTop))
      ...
      function i(c) {
        if (c.offsetWidth) {
          var d,
            ...
            k = 0;
          "body" !== b.opts.scrollableContainer &&
            ((j = b.$sc.offset().top), (k = a(b.o_win).outerHeight() - j - i));
          var l =
              "body" == b.opts.scrollableContainer ? b.helpers.scrollTop() : j,
            m = f.is(".fr-sticky-on");
          ...
          if (
            ...
            q || f.css("position", "fixed"),
              ...
              f.data(
                "top",
                b.node.hasClass(f.get(0), "fr-top") ? f.css("top") : "auto"
              ),
              f.data(
                "bottom",
          ...
          var t = h.top && r(),
            u = h.bottom && s();
          t || u
            ? (f.css("width", n.get(0).getBoundingClientRect().width + "px"),
              m ||
      ...
      function j() {
        ...
        return (
          (c.cssText =
            "position:" +
            ["-webkit-", "-moz-", "-ms-", "-o-", ""].join("sticky; position:") +
            " sticky;"),
          -1 !== c.position.indexOf("sticky") &&
            !b.helpers.isIOS() &&
            !b.helpers.isAndroid() &&
            !b.browser.chrome
        );
    ...
    (a.FE.MODULES.textEdit = function(a) {
      ...
      function c() {
        var b,
          c = a.popups.get("text.edit");
        (b =
          "INPUT" === a.$el.prop("tagName")
          ...
          a.popups.show(
            "text.edit",
            a.$el.offset().left + a.$el.outerWidth() / 2,
            a.$el.offset().top + a.$el.outerHeight(),
            a.$el.outerHeight()
          );
      }
      function d() {
    ...
    (a.FE.MODULES.toolbar = function(b) {
      ...
      function i(a) {
        return (
          ...
          (!!b.button
            ...
            void (!1 !== b.events.trigger("toolbar.hide") && b.$tb.hide()))
        );
      }
      function j() {
      ...
      function q() {
        if (((b.$sc = a(b.opts.scrollableContainer).first()), !b.$wp))
          return !1;
        b.opts.toolbarContainer
          ? (b.shared.$tb
              ? ((b.$tb = b.shared.$tb), b.opts.toolbarInline && l())
    ...
    (a.FE.PLUGINS.align = function(b) {
      function c(c) {
        b.selection.save(), b.html.wrap(!0, !0, !0, !0), b.selection.restore();
        for (var d = b.selection.blocks(), e = 0; e < d.length; e++)
          b.helpers.getAlignment(a(d[e].parentNode)) == c
            ? a(d[e])
                .css("text-align", "")
                .removeClass("fr-temp-div")
            : a(d[e])
      ...
      function e(c, d) {
        ...
        if (e.length) {
          ...
          d
            .find('a.fr-command[data-param1="' + f + '"]')
            .addClass("fr-active")
    ...
    (a.FE.PLUGINS.charCounter = function(b) {
      ...
      function d(d) {
        ...
        return (
          !(
            (!b.keys.ctrlKey(d) && b.keys.isCharacter(e)) ||
            e === a.FE.KEYCODE.IME
          ) ||
          (d.preventDefault(),
          d.stopPropagation(),
      ...
      function e(d) {
        return b.opts.charCounterMax < 0
          ? d
          : a("<div>")
              .html(d)
              .text().length +
              c() <=
            b.opts.charCounterMax
            ? d
            : (b.events.trigger("charCounter.exceeded"), "");
      }
      function f() {
    ...
    (a.FE.PLUGINS.codeBeautifier = function() {
      function a(a, c) {
            ...
            (this.get_tag = function(a) {
              ...
              do {
                ...
                if (
                  ...
                  this.pos++,
                  this.Utils.in_array(d, this.Utils.whitespace))
                )
                  g = !0;
                else {
                  if (
                    (("'" != d && '"' != d) ||
                      ((d += this.get_unformatted(d)), (g = !0)),
                    "=" == d && (g = !1),
                    e.length && "=" != e[e.length - 1] && ">" != d && g)
                  ) {
                    if (
                      (this.space_or_wrap(e),
                      (g = !1),
                      !h && "force" == r && "/" != d)
                    ) {
              ...
              (o =
                -1 != t.indexOf(" ")
                  ? t.indexOf(" ")
                  : "{" == t[0] ? t.indexOf("}") : t.indexOf(">")),
                (p = "<" != t[0] && q ? ("#" == t[2] ? 3 : 2) : 1);
              var u = t.substring(p, o).toLowerCase();
              return (
                "/" == t.charAt(t.length - 2) ||
                this.Utils.in_array(u, this.Utils.single_token)
                  ...
                  : q && "{" == t[0] && "else" == u
                    ...
                    : this.is_unformatted(u, n)
                      ? ((f = this.get_unformatted("</" + u + ">", t)),
                        e.push(f),
                        this.pos - 1,
                      ...
                      : "script" == u &&
                        ...
                        ? a || (this.record_tag(u), (this.tag_type = "SCRIPT"))
                        : "style" == u &&
                          (-1 == t.search("type") ||
                            (t.search("type") > -1 &&
                              t.search("text/css") > -1))
                          ? a || (this.record_tag(u), (this.tag_type = "STYLE"))
                          : "!" == u.charAt(0)
                            ? a ||
                              ((this.tag_type = "SINGLE"),
                              this.traverse_whitespace())
                            : a ||
                              ("/" == u.charAt(0)
                                ? (this.retrieve_tag(u.substring(1)),
                                  (this.tag_type = "END"))
                                : (this.record_tag(u),
                                  "html" != u.toLowerCase() &&
                                    (this.indent_content = !0),
                              ...
                              this.traverse_whitespace() &&
                                this.space_or_wrap(e),
                              this.Utils.in_array(u, this.Utils.extra_liners) &&
        ...
        for (
          c = c || {},
            ...
            i = void 0 !== c.indent_inner_html && c.indent_inner_html,
            ...
            o = void 0 === c.preserve_newlines || c.preserve_newlines,
            p = o
              ? isNaN(parseInt(c.max_preserve_newlines, 10))
                ? 32786
                : parseInt(c.max_preserve_newlines, 10)
              : 0,
            q = void 0 !== c.indent_handlebars && c.indent_handlebars,
            ...
            t = void 0 !== c.end_with_newline && c.end_with_newline,
      ...
      function g(a, b) {
        ...
        function E() {
          ...
          ("none" === ba.brace_style && U.wanted_newline)
            ...
            : "TK_OPERATOR" !== V && "TK_START_EXPR" !== V
              ? "TK_START_BLOCK" === V ? n() : (R.space_before_token = !0)
              : t(Z.mode) &&
                "," === Y.last_text &&
        ...
        function H() {
          for (
            x() && (R.space_before_token = !1);
            Y.mode === l.Statement && !Y.if_block && !Y.do_block;
          ...
          (c(U.text, ["-", "+"]) &&
            ...
            ? ((a = !1),
              ...
              (Y.mode !== l.BlockStatement && Y.mode !== l.Statement) ||
                ...
                n())
            : ":" === U.text
              ? 0 === Y.ternary_depth ? (a = !1) : (Y.ternary_depth -= 1)
              : "?" === U.text
                ? (Y.ternary_depth += 1)
                : "*" === U.text &&
                  "TK_RESERVED" === V &&
        ...
        for (
          aa = {
            ...
            ba.brace_style = b.brace_style
              ? b.brace_style
              : ba.brace_style ? ba.brace_style : "collapse",
            ...
            ba.eol = b.eol ? b.eol : "\n",
            ba.preserve_newlines =
              void 0 === b.preserve_newlines || b.preserve_newlines,
            ba.break_chained_methods =
              void 0 !== b.break_chained_methods && b.break_chained_methods,
            ba.max_preserve_newlines =
              void 0 === b.max_preserve_newlines
                ? 0
                : parseInt(b.max_preserve_newlines, 10),
            ba.space_in_paren = void 0 !== b.space_in_paren && b.space_in_paren,
            ba.space_in_empty_paren =
              void 0 !== b.space_in_empty_paren && b.space_in_empty_paren,
            ba.jslint_happy = void 0 !== b.jslint_happy && b.jslint_happy,
            ba.space_after_anon_function =
              void 0 !== b.space_after_anon_function &&
              b.space_after_anon_function,
            ba.keep_array_indentation =
              void 0 !== b.keep_array_indentation && b.keep_array_indentation,
            ba.space_before_conditional =
              void 0 === b.space_before_conditional ||
              b.space_before_conditional,
            ba.unescape_strings =
              void 0 !== b.unescape_strings && b.unescape_strings,
            ba.wrap_line_length =
              void 0 === b.wrap_line_length
                ? 0
                : parseInt(b.wrap_line_length, 10),
            ba.e4x = void 0 !== b.e4x && b.e4x,
            ba.end_with_newline =
              void 0 !== b.end_with_newline && b.end_with_newline,
            ba.comma_first = void 0 !== b.comma_first && b.comma_first,
            ba.test_output_raw =
              void 0 !== b.test_output_raw && b.test_output_raw,
            ba.jslint_happy && (ba.space_after_anon_function = !0),
            b.indent_with_tabs &&
              ((ba.indent_char = "\t"), (ba.indent_size = 1)),
        ...
        (this.baseIndentString = b),
          ...
          (this.remove_redundant_indentation = function(a) {
            if (
              ...
              for (var b = a.start_line_index, d = c.length; b < d; )
                c[b].remove_indent(), b++;
          }),
          (this.trim = function(d) {
            for (
              d = void 0 !== d && d, this.current_line.trim(a, b);
        ...
        function g() {
          ...
          if (k.isIdentifierStart(a.charCodeAt(t - 1))) {
            if (t < u)
              for (
                ;
                k.isIdentifierChar(a.charCodeAt(t)) &&
                ((z += a.charAt(t)), (t += 1) !== u);
          ...
          if (
            ...
            if (
              ...
              t < u && a.charAt(t) === I && ((e += I), (t += 1), "/" === I))
            )
              for (; t < u && k.isIdentifierStart(a.charCodeAt(t)); )
                (e += a.charAt(t)), (t += 1);
            return [e, "TK_STRING"];
          }
          if ("#" === z) {
          ...
          if ("<" === z && "\x3c!--" === a.substring(t - 1, t + 3)) {
            for (t += 3, z = "\x3c!--"; !k.newline.test(a.charAt(t)) && t < u; )
              (z += a.charAt(t)), t++;
            return (r = !0), [z, "TK_COMMENT"];
          }
          if ("-" === z && r && "--\x3e" === a.substring(t - 1, t + 2))
            return (r = !1), (t += 2), ["--\x3e", "TK_COMMENT"];
          ...
          (a.isIdentifierStart = function(a) {
            return a < 65
              ...
              : a < 91 ||
                (a < 97
                  ? 95 === a
                  : a < 123 || (a >= 170 && d.test(String.fromCharCode(a))));
          }),
    ...
    (a.FE.PLUGINS.codeView = function(b) {
      ...
      function f(c) {
        k ||
          (i(),
          !l && b.opts.codeMirror
            ? (l = b.opts.codeMirror.fromTextArea(
                k.get(0),
        ...
        b.$tb
          ...
          .filter(function() {
            return (
              b.opts.codeViewKeepActiveButtons.indexOf(a(this).data("cmd")) < 0
            );
          })
    ...
    (a.FE.PLUGINS.colors = function(b) {
        ...
        b.events.on(
          ...
          function(d) {
            ...
            if (a.FE.KEYCODE.TAB == f) {
              ...
              a.FE.KEYCODE.ARROW_UP == f ||
              a.FE.KEYCODE.ARROW_DOWN == f ||
              a.FE.KEYCODE.ARROW_LEFT == f ||
              a.FE.KEYCODE.ARROW_RIGHT == f
            ) {
              if (e.is("span.fr-select-color")) {
                ...
                a.FE.KEYCODE.ARROW_UP == f
                  ...
                  : a.FE.KEYCODE.ARROW_DOWN == f
                    ...
                    : a.FE.KEYCODE.ARROW_LEFT == f
                      ? (o = ((o - 1) % p + p) % p)
                      : a.FE.KEYCODE.ARROW_RIGHT == f && (o = (o + 1) % p);
                var q = a(i.get(o));
      ...
      function i(c) {
        ...
        for (
          g.find(".fr-selected-color").remove(),
    ...
    (a.FE.PLUGINS.draggable = function(b) {
      ...
      function f(c) {
        ...
        if (!d(f)) {
          ...
          (!d(h) || (n && 0 === b.$el.find(h).length && h != n.get(0))) &&
            (h = null);
          for (
            var i = 0, j = f;
            !d(j) &&
          ...
          (!d(j) || (n && 0 === b.$el.find(j).length && j != n.get(0))) &&
            (j = null),
            (f =
              null == j && h
                ? h
                : j && null == h ? j : j && h ? (g < i ? h : j) : null);
        }
        if (a(f).hasClass("fr-drag-helper")) return !1;
        if (
          (f && !b.node.isBlock(f) && (f = b.node.blockParent(f)),
          f &&
            ["TD", "TH", "TR", "THEAD", "TBODY"].indexOf(f.tagName) >= 0 &&
            (f = a(f)
              .parents("table")
              .get(0)),
          f &&
            ["LI"].indexOf(f.tagName) >= 0 &&
            (f = a(f)
              .parents("UL, OL")
              .get(0)),
          ...
          var k;
          k =
            c.originalEvent.pageY < a(f).offset().top + a(f).outerHeight() / 2;
          var l = a(f),
            m = 0;
          k || 0 !== l.next().length
            ? (k || (l = l.next()),
              ("before" == n.data("fr-position") && l.is(n.data("fr-tag"))) ||
                (l.prev().length > 0 &&
                  (m = parseFloat(l.prev().css("margin-bottom")) || 0),
                (m = Math.max(m, parseFloat(l.css("margin-top")) || 0)),
                e(
                  l.offset().top - m / 2 - b.$box.offset().top,
                  l.offset().left - b.win.pageXOffset - b.$box.offset().left,
                  l.width()
                ),
                n.data("fr-position", "before")))
            : ("after" == n.data("fr-position") && l.is(n.data("fr-tag"))) ||
              ((m = parseFloat(l.css("margin-bottom")) || 0),
              e(
                l.offset().top + a(f).height() + m / 2 - b.$box.offset().top,
                l.offset().left - b.win.pageXOffset - b.$box.offset().left,
                l.width()
              ),
      ...
      function g(a) {
        (a.originalEvent.dataTransfer.dropEffect = "move"),
          b.opts.dragInline
            ? j() || (!b.browser.msie && !b.browser.edge) || a.preventDefault()
      ...
      function i(a) {
        ...
        n && n.hasClass("fr-visible") && b.$box.find(n).length
          ? k(a)
          : c.length && (a.preventDefault(), a.stopPropagation()),
      ...
      function k(c) {
        ...
        if (d.length) {
          if (
            ...
            n
              .data("fr-tag")
              [n.data("fr-position")]('<span class="fr-marker"></span>'),
          ...
          var g = d;
          if ((d.parent().is("A") && (g = d.parent()), b.core.isEmpty()))
            b.events.focus();
          else {
            b.$el.find(".fr-marker").replaceWith(a.FE.MARKERS),
              b.selection.restore();
          }
          if ((e == b || b.undo.canDo() || b.undo.saveStep(), b.core.isEmpty()))
            b.$el.html(g);
          else {
          ...
          return (
            ...
            e != b &&
              (e.popups.hideAll(),
              e.$el
                .find(e.html.emptyBlockTagsQuery())
                .not("TD, TH, LI, .fr-inner")
                .remove(),
              e.html.wrap(),
      ...
      function l(a) {
        if (a && "DIV" == a.tagName && b.node.hasClass(a, "fr-drag-helper"))
          ...
          for (
            var c = a.querySelectorAll("div.fr-drag-helper"), d = 0;
            d < c.length;
            d++
          )
            c[d].parentNode.removeChild(c[d]);
    ...
    (a.FE.PLUGINS.emoticons = function(b) {
      ...
      function g() {
        for (
          var a = '<div style="text-align: center">', c = 0;
        ...
        return (
          b.opts.emoticonsUseImage &&
            (a +=
              '<p style="font-size: 12px; text-align: center; padding: 0 5px;">Emoji free by <a class="fr-link" tabIndex="-1" href="http://emojione.com/" target="_blank" rel="nofollow" role="link" aria-label="Open Emoji One website.">Emoji One</a></p>'),
          (a += "</div>")
        );
      }
      function h(c) {
        b.events.on(
          ...
          function(d) {
            ...
            if (a.FE.KEYCODE.TAB == i) {
              if (
                (e.is("span.fr-emoticon") && d.shiftKey) ||
                (e.is("a") && !d.shiftKey)
              ) {
              ...
              if (!1 !== f) {
                ...
                e.is("span.fr-emoticon") &&
                  (k = k.not("span.fr-emoticon:not(:focus)")),
                  (g = k.index(e)),
                  (g = d.shiftKey
                    ? ((g - 1) % k.length + k.length) % k.length
                    : (g + 1) % k.length),
                  (h = k.get(g)),
                  b.events.disableBlur(),
                  h.focus(),
              ...
              a.FE.KEYCODE.ARROW_UP == i ||
              a.FE.KEYCODE.ARROW_DOWN == i ||
              a.FE.KEYCODE.ARROW_LEFT == i ||
              a.FE.KEYCODE.ARROW_RIGHT == i
            ) {
              if (e.is("span.fr-emoticon")) {
                ...
                a.FE.KEYCODE.ARROW_UP == i
                  ...
                  : a.FE.KEYCODE.ARROW_DOWN == i
                    ...
                    : a.FE.KEYCODE.ARROW_LEFT == i
                      ? (q = ((q - 1) % r + r) % r)
                      : a.FE.KEYCODE.ARROW_RIGHT == i && (q = (q + 1) % r),
                  (h = a(l.get(q))),
                  b.events.disableBlur(),
                  h.focus(),
                  (f = !1);
              ...
              a.FE.KEYCODE.ENTER == i &&
                (e.is("a") ? e[0].click() : b.button.exec(e), (f = !1));
      ...
      function i(c, d) {
        ...
        e
          ? (0 === g.startOffset && b.selection.element() === e
              ? a(e).before(a.FE.MARKERS + a.FE.INVISIBLE_SPACE)
              : g.startOffset > 0 &&
                b.selection.element() === e &&
                g.commonAncestorContainer.parentNode.classList.contains(
                  "fr-emoticon"
                ) &&
                a(e).after(a.FE.INVISIBLE_SPACE + a.FE.MARKERS),
            b.selection.restore(),
            b.html.insert(
      ...
      function k() {
        var c = function() {
          for (
            var a = b.el.querySelectorAll(".fr-emoticon:not(.fr-deletable)"),
              c = 0;
            c < a.length;
            c++
          )
        ...
        c(),
          ...
          b.events.on("keydown", function(c) {
            if (b.keys.isCharacter(c.which) && b.selection.inEditor()) {
              var d = b.selection.ranges(0),
                e = f();
              b.node.hasClass(e, "fr-emoticon-img") &&
                e &&
                (0 === d.startOffset && b.selection.element() === e
                  ? a(e).before(a.FE.MARKERS + a.FE.INVISIBLE_SPACE)
                  : a(e).after(a.FE.INVISIBLE_SPACE + a.FE.MARKERS),
                b.selection.restore());
            }
          ...
          b.events.on("keyup", function(c) {
            for (
              var d = b.el.querySelectorAll(".fr-emoticon"), e = 0;
              e < d.length;
              e++
            )
              void 0 !== d[e].textContent &&
                0 === d[e].textContent.replace(/\u200B/gi, "").length &&
                a(d[e]).remove();
            if (
              !(
                c.which >= a.FE.KEYCODE.ARROW_LEFT &&
              ...
              var g = f();
              b.node.hasClass(g, "fr-emoticon-img") &&
    ...
    (a.FE.PLUGINS.entities = function(b) {
      ...
      function f() {
        b.opts.htmlSimpleAmpersand ||
          (b.opts.entities = b.opts.entities + "&amp;");
        var c = a("<div>")
    ...
    (a.FE.PLUGINS.file = function(b) {
      ...
      function e(a) {
        ...
        c &&
          ...
          a && (b.events.focus(), b.popups.hide("file.insert")));
      }
      function f(a, c) {
      ...
      function h(a, c, d) {
        b.edit.on(),
          b.events.focus(!0),
          b.selection.restore(),
          b.opts.fileUseSelectedText &&
            b.selection.text().length &&
            (c = b.selection.text()),
          b.html.insert(
            '<a href="' +
              a +
      ...
      function i(a) {
        try {
          if (!1 === b.events.trigger("file.uploaded", [a], !0))
            return b.edit.on(), !1;
          var c = JSON.parse(a);
        ...
        try {
          var d = a(c)
            ...
            e = a(c)
              .find("Key")
              .text();
          return !1 === b.events.trigger("file.uploadedToS3", [d, e, c], !0)
            ? (b.edit.on(), !1)
            : d;
        } catch (f) {
          return n(B, c), !1;
      ...
      function n(a, c) {
        b.edit.on(),
          ...
          b.events.trigger("file.error", [{ code: a, message: E[a] }, c]);
      }
      function o() {
        b.edit.on(), e(!0);
      }
        ...
        if (void 0 !== a && a.length > 0) {
          ...
          if (
            ...
            b.opts.fileUploadToS3 &&
              (g = b.opts.fileUploadToS3.uploadURL
                ? b.opts.fileUploadToS3.uploadURL
                : "https://" +
      ...
      function s(a) {
        ...
        d =
          ...
          '" accept="/*" tabIndex="-1" aria-labelledby="fr-file-upload-layer-' +
          b.id +
          '" role="button"></div></div>';
        var e =
      ...
      function x() {
        ...
        if (F)
          for (a = 0; a < F.length; a++)
            d.indexOf(F[a].getAttribute("href")) < 0 &&
              b.events.trigger("file.unlink", [F[a]]);
        F = c;
      }
      function y() {
        v(),
      ...
      var z = 2,
        ...
        D = 6,
        E = {};
      (E[1] = "File cannot be loaded from the passed link."),
        (E[z] = "No link in upload response."),
        (E[A] = "Error during file upload."),
        (E[B] = "Parsing response failed."),
        (E[C] = "File is too large."),
        (E[D] = "File file type is invalid."),
        (E[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.");
      var F;
      return {
        _init: y,
        showInsertPopup: c,
    ...
    (a.FE.PLUGINS.fontFamily = function(b) {
      ...
      function f(a, b) {
        for (var c = 0; c < a.length; c++)
          for (var d = 0; d < b.length; d++) if (a[c] == b[d]) return [c, d];
        return null;
      }
      function g() {
        ...
        if (b.opts.fontFamilySelection) {
          ...
          c
            ...
            .text(
              b.opts.fontFamily[g()] ||
                d[0] ||
                b.language.translate(b.opts.fontFamilyDefaultSelection)
            );
        }
      }
    ...
    (a.FE.PLUGINS.fullscreen = function(b) {
      ...
      function d() {
        ...
        for (var c = b.$box.parent(); !c.is("body:first"); )
          c
            .data("z-index", c.css("z-index"))
            .data("overflow", c.css("overflow"))
      ...
      function e() {
        ...
        for (var c = b.$box.parent(); !c.is("body:first"); )
          c.data("z-index") &&
            ...
            c.data("overflow")
              ? (c.css("overflow", ""),
                c.css("overflow") != c.data("overflow") &&
                  c.css("overflow", c.data("overflow")),
                c.removeData("overflow"))
              : (c.css("overflow", ""), c.removeData("overflow")),
            (c = c.parent());
    ...
    (a.FE.PLUGINS.help = function(b) {
      ...
      function d() {
        for (
          var c = '<div class="fr-help-modal">', d = 0;
          d < a.FE.DEFAULTS.helpSets.length;
          d++
        ) {
    ...
    (a.FE.PLUGINS.image = function(b) {
      function c() {
        ...
        c.val(""), za && c.val(za.attr("src")), c.trigger("change");
      }
      function d() {
      ...
      function e() {
        ...
        if ((a || (a = q()), a)) {
          ...
          var c = za.offset().left + za.outerWidth() / 2,
            d = za.offset().top + za.outerHeight();
          b.popups.show("image.edit", c, d, za.outerHeight());
        }
      }
      function f() {
        s();
      ...
      function g(a) {
        a.hasClass("fr-dii") ||
          a.hasClass("fr-dib") ||
          (a.addClass("fr-fi" + oa(a)[0]),
          a.addClass("fr-di" + pa(a)[0]),
          a.css("margin", ""),
          a.css("float", ""),
          a.css("display", ""),
          a.css("z-index", ""),
      ...
      function h(a) {
        ma(
          ...
          a.hasClass("fr-dib")
            ? "block"
            : a.hasClass("fr-dii") ? "inline" : null,
          a.hasClass("fr-fil") ? "left" : a.hasClass("fr-fir") ? "right" : oa(a)
        ),
          a.removeClass("fr-dib fr-dii fr-fir fr-fil");
      }
      function i() {
        for (
          var c = "IMG" == b.el.tagName ? [b.el] : b.el.querySelectorAll("img"),
            d = 0;
          d < c.length;
          d++
        ) {
      ...
      function j(c) {
        void 0 === c && (c = !0);
        var d,
          e = Array.prototype.slice.call(b.el.querySelectorAll("img")),
          f = [];
        for (d = 0; d < e.length; d++)
          f.push(e[d].getAttribute("src")),
        ...
        if (Ma)
          for (d = 0; d < Ma.length; d++)
            f.indexOf(Ma[d].getAttribute("src")) < 0 &&
              b.events.trigger("image.removed", [a(Ma[d])]);
        if (Ma && c) {
          var g = [];
          for (d = 0; d < Ma.length; d++) g.push(Ma[d].getAttribute("src"));
          for (d = 0; d < e.length; d++)
            g.indexOf(e[d].getAttribute("src")) < 0 &&
              b.events.trigger("image.loaded", [a(e[d])]);
        }
        Ma = e;
      }
      function k() {
        if ((Aa || Y(), !za)) return !1;
        var a = b.$wp || b.$sc;
        a.append(Aa), Aa.data("instance", b);
        var c =
            a.scrollTop() -
            ("static" != a.css("position") ? a.offset().top : 0),
          d =
            a.scrollLeft() -
        ...
        (d -= b.helpers.getPX(a.css("border-left-width"))),
          ...
          Aa.css(
            "top",
            (b.opts.iframe
              ? za.offset().top + b.$iframe.position().top
              : za.offset().top + c) - 1
          )
            .css(
              "left",
              (b.opts.iframe ? za.offset().left : za.offset().left + d) - 1
            )
            .css("width", za.get(0).getBoundingClientRect().width)
            .css("height", za.get(0).getBoundingClientRect().height)
            .addClass("fr-active");
      }
      function l(a) {
      ...
      function m(c) {
        if (!b.core.sameInstance(Aa)) return !0;
        if (
          (c.preventDefault(),
          c.stopPropagation(),
        ...
        if ("mousedown" == c.type) {
          ...
          h &&
            g.frameElement &&
            (d +=
              b.helpers.getPX(a(g.frameElement).offset().left) +
              g.frameElement.clientLeft);
        }
        (Ba = a(this)),
          Ba.data("start-x", d),
          Ba.data("start-width", za.width()),
          Ba.data("start-height", za.height());
        var i = za.width();
        if (b.opts.imageResizeWithPercent) {
          var j =
            za.parentsUntil(b.$el, b.html.blockTagsQuery()).get(0) || b.el;
          za.css("width", (i / a(j).outerWidth() * 100).toFixed(2) + "%");
        } else za.css("width", i);
        Ca.show(), b.popups.hideAll(), ka();
      }
      function n(c) {
        if (!b.core.sameInstance(Aa)) return !0;
        var d;
        if (Ba && za) {
          ...
          var e =
            c.pageX ||
            (c.originalEvent.touches ? c.originalEvent.touches[0].pageX : null);
          if (!e) return !1;
          var f = Ba.data("start-x"),
            g = e - f,
            h = Ba.data("start-width");
          if (
            ((Ba.hasClass("fr-hnw") || Ba.hasClass("fr-hsw")) && (g = 0 - g),
            ...
            (h = ((h + g) / a(i).outerWidth() * 100).toFixed(2)),
              ...
              za.css("width", h + "%"),
              (d = (b.helpers.getPX(za.css("width")) /
                a(i).outerWidth() *
                100).toFixed(2)),
              d !== h && za.css("width", d + "%"),
              za.css("height", "").removeAttr("height");
          } else
            h + g >= b.opts.imageMinWidth && za.css("width", h + g),
              (d = b.helpers.getPX(za.css("width"))),
              d !== h + g && za.css("width", d),
              (za.attr("style") || "").match(/(^height:)|(; *height:)/) &&
                za.css(
                  "height",
                  Ba.data("start-height") * za.width() / Ba.data("start-width")
                );
          k(), b.events.trigger("image.resize", [xa()]);
        }
      }
      function o(a) {
        if (!b.core.sameInstance(Aa)) return !0;
        if (Ba && za) {
          ...
          (Ba = null),
            ...
            e(),
            b.undo.saveStep(),
            b.events.trigger("image.resizeEnd", [xa()]);
        }
      }
      function p(a, c, d) {
        b.edit.on(),
          za && za.addClass("fr-error"),
          u(b.language.translate("Something went wrong. Please try again.")),
          !za && d && Z(d),
          b.events.trigger("image.error", [{ code: a, message: La[a] }, c, d]);
      }
      function q(a) {
        if (a)
          return (
      ...
      function r(a) {
        ...
        if (
          ...
          var d = za.offset().left + za.width() / 2,
            e = za.offset().top + za.height();
          b.popups.show("image.insert", d, e, za.outerHeight());
        }
      ...
      function s(a) {
        ...
        if (
          ...
          if (
            ...
            var d = za;
            ia(!0), b.selection.setAfter(d.get(0)), b.selection.restore();
          }
      ...
      function z(a) {
        try {
          if (!1 === b.events.trigger("image.uploaded", [a], !0))
            return b.edit.on(), !1;
          var c = JSON.parse(a);
          return c.content.picId ? c : (p(Fa, a), !1);
        } catch (d) {
          return p(Ha, a), !1;
        }
      }
        ...
        try {
          var d = a(c)
            ...
            e = a(c)
              .find("Key")
              .text();
          return !1 === b.events.trigger("image.uploadedToS3", [d, e, c], !0)
            ? (b.edit.on(), !1)
            : d;
        } catch (f) {
          return p(Ha, c), !1;
      ...
      function B(a) {
        ...
        try {
          if (b.opts.imageUploadToS3)
            ...
            var h = z(f);
            h && y(b.opts.loadImgUrl + h.content.picId + '/download', !1, h, a, d || f, a.attr('data-size'));
          } else p(Ga, d || f, a);
        } catch (i) {
          p(Ha, d || f, a);
        }
      ...
      function C() {
        p(Ha, this.response || this.responseText || this.responseXML);
      }
      function D(a) {
        if (a.lengthComputable) {
          var c = (a.loaded / a.total * 100) | 0;
      ...
      function E(c, d, e, s) {
        ...
        ma(i, b.opts.imageDefaultDisplay, b.opts.imageDefaultAlign),
          i.on("load", e),
          i.on("error", function() {
            p(Ka);
          }),
        ...
        return (
          j.length
            ? (j.parent().is("hr") && j.parent().after(j),
              b.node.isLastSibling(j) &&
                j.parent().hasClass("fr-deletable") &&
                j.insertAfter(j.parent()),  //j是span 元素， j.parent是p元素
              j.replaceWith(i))  // span 替换成img
            : b.$el.append(i),
          b.html.wrap(),
          b.selection.clear(),
          i
        ...
        i.addEventListener(
          ...
          function() {
            ...
            if (i.result.indexOf("svg+xml") < 0) {
              for (
                var c = atob(i.result.split(",")[1]), d = [], e = 0;
                e < c.length;
                e++
              )
            ...
            f
              ? (f.on("load", g),
                f.one("error", function() {
                  f.off("load"), f.attr("src", f.data("fr-old-src")), p(Ka);
                }),
                b.edit.on(),
                b.undo.saveStep(),
      ...
      function H(a, c) {
        if (void 0 !== a && a.length > 0) {
          ...
          var d = a[0];
          if (
            (d.name || (d.name = new Date().getTime() + ".jpg"),
            d.size > b.opts.imageMaxSize)
          )
            return p(Ia), !1;
          if (
            b.opts.imageAllowedTypes.indexOf(d.type.replace(/image\//g, "")) < 0
          )
            return p(Ja), !1;
          var e;
          if (
            ...
            if (!1 !== b.opts.imageUploadToS3) {
              ...
              for (f in b.opts.imageUploadToS3.params)
                b.opts.imageUploadToS3.params.hasOwnProperty(f) &&
                  e.append(f, b.opts.imageUploadToS3.params[f]);
            }
            for (f in b.opts.imageUploadParams)
              b.opts.imageUploadParams.hasOwnProperty(f) &&
                e.append(f, b.opts.imageUploadParams[f]);
            e.append(b.opts.imageUploadParam, d, d.name);
            var g = b.opts.imageUploadURL;
            b.opts.imageUploadToS3 &&
              (g = b.opts.imageUploadToS3.uploadURL
                ? b.opts.imageUploadToS3.uploadURL
                : "https://" +
                  b.opts.imageUploadToS3.region +
                  ".amazonaws.com/" +
                  b.opts.imageUploadToS3.bucket);
            G(b.core.getXHR(g, b.opts.imageUploadMethod), e, d, c || za);
          }
        }
      }
      function I(c) {
      ...
      function J(c) {
        ...
        if (d && d.files && d.files.length) {
          ...
          if (e && e.type && -1 !== e.type.indexOf("image")) {
            ...
            return (
              b.opts.iframe &&
                ((h += b.$iframe.offset().top), (g += b.$iframe.offset().left)),
      ...
      function K() {
        b.events.$on(
          b.$el,
          b._mousedown,
          "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])',
          function(c) {
            if (
              "false" ==
              a(this)
          ...
          b.events.$on(
            ...
            function(c) {
              ...
              Da &&
                ...
                c.stopPropagation(),
                b.browser.msie &&
                  (b.$el.attr("contenteditable", !0), b.events.enableBlur()));
            }
          ),
          b.events.on(
            "keyup",
            function(c) {
              if (c.shiftKey && "" === b.selection.text().replace(/\n/g, "")) {
                ...
                d && "IMG" == d.tagName
                  ? w(a(d))
                  : e && "IMG" == e.tagName && w(a(e));
              }
            },
            !0
          ),
          b.events.on("drop", J),
          b.events.on("mousedown window.mousedown", ja),
          b.events.on("window.touchmove", ka),
          b.events.on("mouseup window.mouseup", function() {
            if (za) return ia(), !1;
            ka();
          }),
          b.events.on("commands.mousedown", function(a) {
            a.parents(".fr-toolbar").length > 0 && ia();
          }),
          b.events.on(
      ...
      function L(a) {
        ...
        return (
          b.$wp &&
            b.events.$on(b.$wp, "scroll", function() {
              za && b.popups.isVisible("image.insert") && ua();
            }),
          I(m),
          m
        );
      ...
      function N() {
        ...
        var c = za.offset().left + za.width() / 2,
          d = za.offset().top + za.height();
        b.popups.show("image.alt", c, d, za.outerHeight());
      }
      function O(a) {
        ...
        return (
          b.$wp &&
            b.events.$on(b.$wp, "scroll.image-alt", function() {
              za && b.popups.isVisible("image.alt") && N();
            }),
          f
        );
      }
      function P(a) {
        if (za) {
          ...
          za.attr("alt", a || c.find("input").val() || ""),
            c.find("input:focus").blur(),
            w(za);
        }
      }
      function Q() {
        if (za) {
          ...
          a
            ...
            .val(za.get(0).style.width)
            .trigger("change"),
            a
              .find('input[name="height"]')
              .val(za.get(0).style.height)
              .trigger("change");
        }
      }
      function R() {
        ...
        var c = za.offset().left + za.width() / 2,
          d = za.offset().top + za.height();
        b.popups.show("image.size", c, d, za.outerHeight());
      }
      function S(a) {
        ...
        return (
          b.$wp &&
            b.events.$on(b.$wp, "scroll.image-size", function() {
              za && b.popups.isVisible("image.size") && R();
            }),
          f
        );
      }
      function T(a, c) {
        if (za) {
          ...
          var e = /^[\d]+((px)|%)*$/g;
          a.match(e) ? za.css("width", a) : za.css("width", ""),
            c.match(e) ? za.css("height", c) : za.css("height", ""),
      ...
      function U(a) {
        ...
        if (za || b.opts.toolbarInline)
          za && (d = za.offset().top + za.outerHeight());
        else {
        ...
        !za &&
          ...
          b.popups.show("image.insert", c, d, za ? za.outerHeight() : 0),
        ...
        if (
          (b.shared.$image_resizer
            ? ((Aa = b.shared.$image_resizer),
              (Ca = b.shared.$img_overlay),
              b.events.on(
                "destroy",
                function() {
                  Aa.removeClass("fr-active").appendTo(a("body:first"));
                },
                !0
              ))
            : ((b.shared.$image_resizer = a(
              ...
              b.opts.imageResize &&
                (Aa.append(l("nw") + l("ne") + l("sw") + l("se")),
                (b.shared.$img_overlay = a(
                  '<div class="fr-image-overlay"></div>'
                )),
                (Ca = b.shared.$img_overlay),
                (c = Aa.get(0).ownerDocument),
                a(c)
                  .find("body:first")
                  .append(Ca))),
          b.events.on(
            ...
            function() {
              Aa.html("")
                ...
                .remove(),
                (Aa = null),
                b.opts.imageResize && (Ca.remove(), (Ca = null));
            },
            !0
          ),
          b.helpers.isMobile() ||
            b.events.$on(a(b.o_win), "resize", function() {
              za && !za.hasClass("fr-uploading")
                ? ia(!0)
                : za && (k(), ua(), r(!1));
            }),
          b.opts.imageResize)
            ...
            function(c) {
              if (za) {
                ...
                (h !== e || c.timeStamp - f > 200) && (d = 1),
                  (h == a.FE.KEYCODE.EQUALS ||
                    (b.browser.mozilla && h == a.FE.KEYCODE.FF_EQUALS)) &&
                  g &&
                  !c.altKey
                    ? (d = X.call(this, c, 1, 1, d))
                    : (h == a.FE.KEYCODE.HYPHEN ||
                        (b.browser.mozilla && h == a.FE.KEYCODE.FF_HYPHEN)) &&
                      g &&
                      !c.altKey
                      ? (d = X.call(this, c, 2, -1, d))
                      : b.keys.ctrlKey(c) ||
      ...
      function Z(c) {
        (c = c || za) &&
          !1 !== b.events.trigger("image.beforeRemove", [c]) &&
          (b.popups.hideAll(),
          va(),
          ia(!0),
          b.undo.canDo() || b.undo.saveStep(),
      ...
      function $(c) {
        var d = c.which;
        if (za && (d == a.FE.KEYCODE.BACKSPACE || d == a.FE.KEYCODE.DELETE))
          return c.preventDefault(), c.stopPropagation(), Z(), !1;
        if (za && d == a.FE.KEYCODE.ESC) {
          var e = za;
          return (
            ia(!0),
        ...
        if (
          ...
          return (
            ia(!0),
            d == a.FE.KEYCODE.ARROW_LEFT
              ? b.selection.setBefore(f)
              : b.selection.setAfter(f),
            b.selection.restore(),
            c.preventDefault(),
            !1
          );
        }
        return za && d != a.FE.KEYCODE.F10 && !b.keys.isBrowserAction(c)
          ? (c.preventDefault(), c.stopPropagation(), !1)
          : void 0;
      }
      function _(a) {
        if (a && "IMG" == a.tagName)
          b.node.hasClass(a, "fr-uploading") || b.node.hasClass(a, "fr-error")
            ? a.parentNode.removeChild(a)
            : b.node.hasClass(a, "fr-draggable") &&
      ...
      function aa() {
        if (
          ...
          b.$wp
            ? (b.events.on("window.keydown keydown", $, !0),
              b.events.on(
                "keyup",
                function(b) {
                  if (za && b.which == a.FE.KEYCODE.ENTER) return !1;
                },
                !0
              ))
            ...
            function() {
              if (za) {
                if (b.$wp) b.events.disableBlur(), b.events.focus();
                  ...
                  var a = za;
                  ia(!0), b.selection.setAfter(a.get(0)), b.selection.restore();
                }
                return !1;
              }
            },
          ...
          b.events.on(
            ...
            function(a) {
              za &&
                ...
                (va(),
                b.paste.saveCopiedText(za.get(0).outerHTML, "\n"),
                "copy" == a.type
                  ? setTimeout(function() {
                      w(za);
                    })
          ...
          b.browser.msie &&
            b.events.on("keydown", function(c) {
              if (!b.selection.isCollapsed() || !za) return !0;
              var d = c.which;
              d == a.FE.KEYCODE.C && b.keys.ctrlKey(c)
                ? b.events.trigger("window.copy")
                : d == a.FE.KEYCODE.X &&
                  b.keys.ctrlKey(c) &&
                  b.events.trigger("window.cut");
            }),
          b.events.$on(a(b.o_win), "keydown", function(b) {
            var c = b.which;
            if (za && c == a.FE.KEYCODE.BACKSPACE)
              return b.preventDefault(), !1;
          }),
          b.events.$on(b.$win, "keydown", function(b) {
            var c = b.which;
            za &&
              za.hasClass("fr-uploading") &&
              c == a.FE.KEYCODE.ESC &&
              za.trigger("abortUpload");
          }),
          b.events.on("destroy", function() {
            za && za.hasClass("fr-uploading") && za.trigger("abortUpload");
          }),
          b.events.on("paste.before", fa),
          b.events.on("paste.beforeCleanup", ga),
      ...
      function ba(c) {
        ...
        H([new Blob([new Uint8Array(f)], { type: "image/jpeg" })], za);
      }
      function ca() {
        b.opts.imagePaste
          ? b.$el.find("img[data-fr-image-pasted]").each(function(c, d) {
              if (b.opts.imagePasteProcess) {
                ...
                e &&
                  "auto" != e &&
                  (e += b.opts.imageResizeWithPercent ? "%" : "px"),
                  a(d)
                    .css("width", e)
              ...
              if (0 === d.src.indexOf("data:")) ba(d);
                ...
                0 === d.src.indexOf("https://mail.google.com/mail")
                  ? (b.selection.save(), a(d).remove(), b.selection.restore())
        ...
        !b.opts.htmlUntouched && b.opts.useClasses
          ...
          : "inline" == c
            ? (a.css({
              ...
              "center" == d
                ? a.css({
                    ...
                    marginTop: "",
                    maxWidth:
                      "calc(100% - " + 2 * b.opts.imageDefaultMargin + "px)"
                  })
                : "left" == d
                  ? a.css({
                      float: "left",
                      marginLeft: 0,
                      maxWidth:
                        "calc(100% - " + b.opts.imageDefaultMargin + "px)"
                    })
                  : a.css({
                      float: "right",
                      marginRight: 0,
            ...
            : "block" == c &&
              ...
              "left" == d
                ? a.css({ marginLeft: 0 })
                : "right" == d && a.css({ marginRight: 0 }));
      }
      function na(a) {
        za.removeClass("fr-fir fr-fil"),
          !b.opts.htmlUntouched && b.opts.useClasses
            ? "left" == a
              ? za.addClass("fr-fil")
              : "right" == a && za.addClass("fr-fir")
            : ma(za, pa(), a),
          va(),
          k(),
          e(),
      ...
      function qa(a) {
        za &&
          a.find("> *:first").replaceWith(b.icon.create("image-align-" + oa()));
      }
      function ra(a, b) {
        za &&
          b
            .find('.fr-command[data-param1="' + oa() + '"]')
            .addClass("fr-active")
            .attr("aria-selected", !0);
      }
      function sa(a) {
        za.removeClass("fr-dii fr-dib"),
          !b.opts.htmlUntouched && b.opts.useClasses
            ? "inline" == a
              ? za.addClass("fr-dii")
              : "block" == a && za.addClass("fr-dib")
            : ma(za, a, oa()),
          va(),
          k(),
          e(),
      ...
      function ta(a, b) {
        za &&
          b
            .find('.fr-command[data-param1="' + pa() + '"]')
            .addClass("fr-active")
            .attr("aria-selected", !0);
      }
      function ua() {
        ...
        var c = za.offset().left + za.width() / 2,
          d = za.offset().top + za.height();
        b.popups.show("image.insert", c, d, za.outerHeight());
      }
      function va() {
        if (za) {
          b.events.disableBlur(), b.selection.clear();
          var a = b.doc.createRange();
          a.selectNode(za.get(0));
          b.selection.get().addRange(a), b.events.enableBlur();
        }
      }
      function wa() {
        za
          ? (b.events.disableBlur(), a(".fr-popup input:focus").blur(), w(za))
          : (b.events.disableBlur(),
            b.selection.restore(),
            b.events.enableBlur(),
            b.popups.hide("image.insert"),
      ...
      function ya(a, c, d) {
        ...
        if (!d) {
          var e = Object.keys(c);
          e.splice(e.indexOf(a), 1), za.removeClass(e.join(" "));
        }
        "object" == typeof c[a]
          ? (za.removeAttr("style"), za.css(c[a].style))
          : za.toggleClass(a),
          w(za);
      }
      var za,
        ...
        Ka = 8,
        La = {};
      (La[Ea] = "Image cannot be loaded from the passed link."),
        (La[Fa] = "No link in upload response."),
        (La[Ga] = "Error during file upload."),
        (La[Ha] = "Parsing response failed."),
        (La[Ia] = "File is too large."),
        (La[Ja] = "Image file type is invalid."),
        (La[7] = "Files can be uploaded only to same domain in IE 8 and IE 9."),
        (La[Ka] = "Image file is corrupted.");
      var Ma,
        Na,
        Oa = !1;
      return {
        ...
        align: na,
        refreshAlign: qa,
        refreshAlignOnShow: ra,
        display: sa,
        refreshDisplayOnShow: ta,
        replace: ua,
        back: wa,
        get: xa,
        insert: y,
        ...
        d &&
          c.find(".fr-command").each(function() {
            var b = a(this).data("param1"),
              c = d.hasClass(b);
            a(this)
              .toggleClass("fr-active", c)
              .attr("aria-selected", c);
          });
      }
    }),
    ...
    (a.FE.PLUGINS.imageManager = function(b) {
      ...
      function i() {
        if (
          H < F.length &&
          (D.outerHeight() <=
            B.outerHeight() + b.opts.imageManagerScrollOffset ||
            B.scrollTop() + b.opts.imageManagerScrollOffset >
              D.outerHeight() - B.outerHeight())
        ) {
          G++;
          for (
            var a = b.opts.imageManagerPageSize * (G - 1);
        ...
        n(!1),
          (d.onload = function() {
            ...
            if ((c.url && f.attr("data-url", c.url), c.tag))
              if (
                (A.find(".fr-modal-more.fr-not-available").removeClass(
                  "fr-not-available"
                ),
          ...
          (d.onerror = function() {
            H++,
              e.remove(),
              m(
                l(parseInt(e.attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)
              ),
              s(L, c),
              H % b.opts.imageManagerPageSize == 0 && i();
          }),
      ...
      function k() {
        var b, c;
        return (
          D.find(".fr-list-column").each(function(d, e) {
            var f = a(e);
            0 === d
              ? ((c = f.outerHeight()), (b = f))
      ...
      function p(c) {
        ...
        if ((b.modals.hide(K), e.image.showProgressBar(), f))
          f.data("fr-old-src", f.attr("src")), f.trigger("click");
        else {
      ...
      function q() {
        z.find("#fr-modal-tags > a").each(function() {
          0 ===
            z.find('#fr-image-list [data-tag*="' + a(this).text() + '"]')
              .length &&
            a(this)
      ...
      function r(c) {
        ...
        confirm(e) &&
          (b.opts.imageManagerDeleteURL
            ? !1 !== b.events.trigger("imageManager.beforeDeleteImage", [d]) &&
      ...
      function t() {
        ...
        A.toggleClass("fr-show-tags"),
          A.hasClass("fr-show-tags")
            ? (A.css("height", a + b), E.find("a").css("opacity", 1))
            : (A.css("height", a), E.find("a").css("opacity", 0));
      }
      function u() {
      ...
      function w(a, b) {
        for (
          var c = (a.attr("data-tag") || "").split(","), d = 0;
          d < c.length;
          d++
        )
          if (c[d] == b) return !0;
      ...
      function x() {
        (C = z.find("#fr-preloader")),
          ...
          b.helpers.isMobile() &&
            (b.events.bindClick(D, "div.fr-image-container", function(b) {
      ...
      return (
        ...
        { require: ["image"], _init: y, show: c, hide: d }
      );
    }),
    !a.FE.PLUGINS.image)
  )
  ...
  a.FE.DEFAULTS.imageInsertButtons.push("imageManager"),
    ...
    (a.FE.PLUGINS.lineBreaker = function(b) {
      function c(a, c) {
        ...
        b.opts.iframe &&
          ((e += b.$iframe.offset().left - b.helpers.scrollLeft()),
      ...
      function d(a, d) {
        ...
        if (
          ...
          if (Math.abs(i - d) < Math.abs(d - h)) {
            ...
            for (
              var j = g.nextSibling;
              j && j.nodeType == Node.TEXT_NODE && 0 === j.textContent.length;
      ...
      function e(c) {
        if (c) {
          ...
          if (d.parents(b.opts.lineBreakerTags.join(",")).length > 0)
            return (
              (c = d.parents(b.opts.lineBreakerTags.join(",")).get(0)),
              0 !== b.$el.find(c).length &&
              a(c).is(b.opts.lineBreakerTags.join(","))
                ? a(c)
                : null
            );
        }
      ...
      function f(c, d) {
        ...
        return e &&
        !a(e).closest(".fr-line-breaker").length &&
        !b.node.isElement(e) &&
        e != b.$wp.get(0) &&
        a(e).closest(b.$wp).length
          ? e
          : null;
      }
      function g(a, c, d) {
        for (var e = d, g = null; e <= b.opts.lineBreakerOffset && !g; )
          (g = f(a, c - e)), g || (g = f(a, c + e)), (e += d);
        return g;
      }
      function h(a, c, d) {
        for (
          ...
          !e &&
          a > b.$box.offset().left &&
          a < b.$box.offset().left + b.$box.outerWidth();

        )
          (e = f(a, c)),
            e || (e = g(a, c, 5)),
            "left" == d
              ? (a -= b.opts.lineBreakerHorizontalOffset)
              : (a += b.opts.lineBreakerHorizontalOffset);
        return e;
      }
      function i(a) {
        ...
        ("HTML" == i.tagName ||
          "BODY" == i.tagName ||
          b.node.isElement(i) ||
          (i.getAttribute("class") || "").indexOf("fr-line-breaker") >= 0)
          ? ((f = g(
              a.pageX - b.win.pageXOffset,
              a.pageY - b.win.pageYOffset,
              1
            ...
            f ||
              (f = h(
                a.pageX -
                  b.win.pageXOffset -
                  b.opts.lineBreakerHorizontalOffset,
                a.pageY - b.win.pageYOffset,
                "left"
              )),
            f ||
          ...
          c
            ? d(c, a.pageY)
            : b.core.sameInstance(q) &&
              q.removeClass("fr-visible").removeData("instance");
      }
      function j(a) {
        return (
          !(q.hasClass("fr-visible") && !b.core.sameInstance(q)) &&
          (b.popups.areVisible() || b.el.querySelector(".fr-selected-cell")
            ? (q.removeClass("fr-visible"), !0)
            : void (
                !1 !== r ||
                b.edit.isDisabled() ||
                (s && clearTimeout(s), (s = setTimeout(i, 30, a)))
              ))
        );
      }
      function k() {
        s && clearTimeout(s),
          q.hasClass("fr-visible") &&
            q.removeClass("fr-visible").removeData("instance");
      }
      function l() {
        (r = !0), k();
      ...
      function n(c) {
        ...
        var d = q.data("tag1"),
          ...
          f = b.html.defaultTag();
        null == d
          ? f && "TD" != e.parent().get(0).tagName && 0 === e.parents(f).length
            ? e.before("<" + f + ">" + a.FE.MARKERS + "<br></" + f + ">")
            : e.before(a.FE.MARKERS + "<br>")
          : f && "TD" != d.parent().get(0).tagName && 0 === d.parents(f).length
      ...
      function p() {
        ...
        o(),
          (r = !1),
          b.events.$on(b.$win, "mousemove", j),
          b.events.$on(a(b.win), "scroll", k),
          b.events.on("popups.show.table.edit", k),
          b.events.on("commands.after", k),
          b.events.$on(a(b.win), "mousedown", l),
          b.events.$on(a(b.win), "mouseup", m);
      }
      var q, r, s;
      return { _init: p };
    }),
    ...
    (a.FE.PLUGINS.link = function(b) {
          ...
          return (
            ...
            "A" == f.tagName ||
              ...
              (f = a(f)
                ...
                .get(0)),
            f &&
              ((f.contains && f.contains(b.el)) ||
                !b.el.contains(f) ||
                b.el == f) &&
              (f = null),
            e &&
              ((e.contains && e.contains(b.el)) ||
                !b.el.contains(e) ||
                b.el == e) &&
              (e = null),
      ...
      function e(d) {
        if (b.core.hasFocus()) {
          if (
            ...
            d &&
              "keyup" === d.type &&
              (d.altKey || d.which == a.FE.KEYCODE.ALT))
          )
            return !0;
          setTimeout(function() {
      ...
      function l(a) {
        ...
        (f =
          ...
          (f +=
            ...
            b.id +
            '" name="href" type="text" class="fr-link-attr" placeholder="URL" tabIndex="' +
            ++g +
            '"></div>'),
          b.opts.linkText &&
            (f +=
      ...
      function n() {
        b.events.on("keyup", function(b) {
          ...
          b.events.on(
            "toolbar.esc",
            function() {
              if (b.popups.isVisible("link.edit"))
                return b.events.disableBlur(), b.events.focus(), !1;
            },
            !0
          );
      }
      ...
      function p() {
        ...
        for (d = 0; d < f.length; d++)
          (c = a(f[d])),
            ["href", "text"].indexOf(c.attr("name")) < 0 &&
              (j[c.attr("name")] = c.val());
        for (d = 0; d < g.length; d++)
          (c = a(g[d])),
            c.is(":checked")
              ? (j[c.attr("name")] = c.data("checked"))
              : (j[c.attr("name")] = c.data("unchecked") || null);
      ...
      function r(f, g, h) {
        ...
        if (
          ("" === b.opts.linkAutoPrefix ||
            new RegExp("^(" + a.FE.LinkProtocols.join("|") + "):.", "i").test(
              f
            ) ||
            /^data:image.*/i.test(f) ||
        ...
        if (m)
          ...
          for (var n = d(), o = 0; o < n.length; o++)
            (l = a(n[o])), l.attr(h), l.removeAttr("_moz_dirty");
          1 == n.length &&
            b.$wp &&
            !i &&
            (a(n[0])
    ...
    a.FE.RegisterCommand("linkBack", {
      ...
      refresh: function(a) {
        ...
        (this.image ? this.image.get() : null) || b || this.opts.toolbarInline
          ? (a.removeClass("fr-hidden"),
            a.next(".fr-separator").removeClass("fr-hidden"))
          : (a.addClass("fr-hidden"),
            a.next(".fr-separator").addClass("fr-hidden"));
    ...
    (a.FE.PLUGINS.lists = function(b) {
      ...
      function f(c, d) {
        ...
        c.length &&
          (f =
            "rtl" == b.opts.direction || "rtl" == a(c[0]).css("direction")
              ? "margin-right"
              : "margin-left");
        for (var i = 0; i < c.length; i++)
          if ("LI" != c[i].tagName) {
            ...
            for (j -= h; j / b.opts.indentMargin > 0; )
              (k += "<" + d + ">"), (l += l), (j -= b.opts.indentMargin);
            g && c[i].tagName.toLowerCase() == g
              ? a(c[i]).replaceWith(
                  k +
                    "<li" +
                    b.node.attributes(c[i]) +
                    ">" +
                    a(c[i]).html() +
                    "</li>" +
                    l
                )
              : a(c[i]).wrap(k + "<li></li>" + l);
          }
        b.clean.lists();
      }
      function g(e) {
        ...
        for (f = 0; f < e.length; f++) {
          var i = a(e[f]),
            j = e[f].parentNode,
            k = i.attr("class");
          if ((i.before(d(j.tagName)), "LI" == j.parentNode.tagName))
            i.before(d("LI")), i.after(c("LI"));
          else {
            var l = "";
            k && (l += ' class="' + k + '"');
            var m =
              "rtl" == b.opts.direction || "rtl" == i.css("direction")
                ? "margin-right"
                : "margin-left";
            b.helpers.getPX(a(j).css(m)) &&
              (l +=
                ' style="' + m + ":" + b.helpers.getPX(a(j).css(m)) + 'px;"'),
              l &&
                i.wrapInner(
                  "<" +
                    b.html.defaultTag() +
        ...
        for (f = 0; f < h.length; f++) {
          ...
          (o = o.replace(/<span class="fr-close-([a-z]*)"><\/span>/g, "</$1>")),
            ...
            n.replaceWith(
              b.node.openTagString(n.get(0)) +
                o +
                b.node.closeTagString(n.get(0))
            );
        }
        b.$el.find("li:empty").remove(),
      ...
      function j(c, d) {
        ...
        if (e.get(0) != b.el) {
          ...
          (f =
            "LI" != f.tagName &&
            f.firstElementChild &&
            "LI" != f.firstElementChild.tagName
              ? e.parents("li").get(0)
              : "LI" == f.tagName || f.firstElementChild
                ? f.firstElementChild && "LI" == f.firstElementChild.tagName
                  ? e.get(0).firstChild
                  : e.get(0)
                : e.parents("li").get(0)),
            f &&
              f.parentNode.tagName == d &&
              b.el.contains(f.parentNode) &&
      ...
      function k(c) {
        ...
        for (var d = 0; d < c.length; d++) {
          ...
          if (e) {
            ...
            if (f) {
              for (
                var g = a("<li>").prependTo(a(f)), h = b.node.contents(c[d])[0];
                h && !b.node.isList(h);
      ...
      function m(a) {
        if ("indent" == a || "outdent" == a) {
          for (
            var c = !1, d = b.selection.blocks(), e = [], f = 0;
            f < d.length;
            f++
          )
            "LI" == d[f].tagName
          ...
          b.events.on(
            ...
            function(c) {
              if (c.which == a.FE.KEYCODE.TAB) {
                for (
                  var d = b.selection.blocks(), e = [], f = 0;
                  f < d.length;
                  f++
                )
                  "LI" == d[f].tagName
                ...
                if (
                  e.length > 1 ||
                  (e.length &&
                    (b.selection.info(e[0]).atStart || b.node.isEmpty(e[0])))
                )
                  return (
                    c.preventDefault(),
                    c.stopPropagation(),
      ...
      function c(c, d) {
        ...
        if (d && d.toLowerCase() != e)
          if (c.find("ul, ol").length > 0) {
            ...
            c.prepend(f);
            for (
              var g = b.node.contents(c.get(0))[0];
              g && ["UL", "OL"].indexOf(g.tagName) < 0;
          ...
          if (h[i].tagName != g && !b.node.isList(h[i])) {
            ...
            "LI" == h[i].tagName
              ...
              : "LI" == h[i].parentNode.tagName && h[i]
                ? d(j, g)
                : ["TD", "TH"].indexOf(h[i].parentNode.tagName) >= 0
                  ? e(j, g)
                  : f(j, g);
          }
        b.$el
        ...
        if (b.opts.paragraphFormatSelection) {
          ...
          if (c.length) {
            ...
            d.tagName.toLowerCase() != f && d != b.el && (e = d.tagName),
              ...
              a
                .find("> span")
                .text(b.language.translate(b.opts.paragraphFormat[e]));
          } else
            a
              .find("> span")
              .text(b.language.translate(b.opts.paragraphFormat.N));
        }
      }
    ...
    (a.FE.PLUGINS.paragraphStyle = function(b) {
      function c(c, d, e) {
        ...
        var f = "";
        e ||
          ((f = Object.keys(d)), f.splice(f.indexOf(c), 1), (f = f.join(" "))),
          b.selection.save(),
          b.html.wrap(!0, !0, !0, !0),
          b.selection.restore();
    ...
    (a.FE.PLUGINS.print = function(a) {
      function b() {
        var b = a.$el.html(),
          c = null;
        a.shared.print_iframe
          ? (c = a.shared.print_iframe)
        ...
        Array.prototype.forEach.call(e, function(a) {
          ...
          d.document.write(
            '</head><body style="text-align: ' +
              ("rtl" == a.opts.direction ? "right" : "left") +
              "; direction: " +
              a.opts.direction +
              ';"><div class="fr-view">'
          ),
    ...
    a.FE.DefineIcon("print", { NAME: "print" }),
    ...
    (a.FE.PLUGINS.quickInsert = function(b) {
      function c(a) {
        ...
        (c = a.offset().top - b.$box.offset().top),
          ...
          b.opts.iframe &&
            (c += b.$iframe.offset().top - b.helpers.scrollTop()),
          k.hasClass("fr-on") && c >= 0 && l.css("top", c - e),
          c >= 0 && c - e <= b.$box.outerHeight() - a.outerHeight()
            ? (k.hasClass("fr-hidden") &&
                (k.hasClass("fr-on") && g(), k.removeClass("fr-hidden")),
              k.css("top", c - e))
            : k.hasClass("fr-visible") && (k.addClass("fr-hidden"), h()),
          k.css("left", d);
      }
      function d(a) {
        k || i(),
      ...
      function e() {
        if (b.core.hasFocus()) {
          ...
          b.node.isBlock(c) || (c = b.node.blockParent(c)),
            c &&
            b.node.isEmpty(c) &&
            b.node.isElement(c.parentNode) &&
            b.opts.quickInsertTags.indexOf(c.tagName.toLowerCase()) >= 0
              ? k && k.data("tag").is(a(c)) && k.hasClass("fr-on")
                ? h()
                : b.selection.isCollapsed() && d(a(c))
              : f();
        }
      }
      function f() {
      ...
      function j() {
        ...
        b.opts.iframe &&
          ...
          b.helpers.isMobile() &&
            b.events.$on(a(b.o_doc), "selectionchange", e),
          b.events.on("blur", f),
          b.events.on("keyup", e),
    ...
    (a.FE.PLUGINS.save = function(b) {
      ...
      function d(d) {
        if (
          (void 0 === d && (d = b.html.get()),
          !1 === b.events.trigger("save.before"))
        )
          return !1;
        if (b.opts.saveURL) {
          var e = {};
      ...
      return (
        ...
        { _init: h, save: d, reset: f, force: g }
      );
    }),
    ...
    (a.FE.PLUGINS.specialCharacters = function(b) {
      ...
      function d() {
        for (
          var c = '<div class="fr-special-characters-modal">', d = 0;
          d < a.FE.DEFAULTS.specialCharactersSets.length;
          d++
        ) {
          for (
            var e = a.FE.DEFAULTS.specialCharactersSets[d],
              f = e.list,
              g =
        ...
        b.events.$on(
          ...
          function(c) {
            ...
            if (
              ...
              return (
                d == a.FE.KEYCODE.ARROW_LEFT || d == a.FE.KEYCODE.ARROW_RIGHT
                  ? ((h = d == a.FE.KEYCODE.ARROW_RIGHT), (i = !0))
                  : (h = !c.shiftKey),
                f.length
                  ? (i &&
                      (g = h
                        ? f.nextAll("span.fr-special-character:first")
                        : f.prevAll("span.fr-special-character:first")),
                    (g && g.length) ||
                      ((g = h
                        ? f
                            .parent()
                        ...
                        : f
                            ...
                            .prev()
                            .find(
                              "span.fr-special-character:" +
                                (i ? "last" : "first")
                            )),
                      g.length ||
                        (g = l.find(
                          "span.fr-special-character:" + (h ? "first" : "last")
                        ))))
                  : (g = l.find(
                      "span.fr-special-character:" + (h ? "first" : "last")
                    )),
    ...
    (a.FE.PLUGINS.table = function(b) {
      ...
      function h(a) {
        ...
        for (var f = 1; f <= b.opts.tableInsertMaxSize; f++)
          for (var g = 0; g <= b.opts.tableInsertMaxSize; g++) {
            var h = e.find(
              '> span[data-row="' + f + '"][data-col="' + g + '"]'
            );
            f <= c && g <= d
              ? h.addClass("hover")
              : f <= c + 1 || (f <= 2 && !b.helpers.isMobile())
                ? h.css("display", "inline-block")
                : f > 2 && !b.helpers.isMobile() && h.css("display", "none");
          }
              ...
              if (
                ...
                if (d.is("span.fr-table-cell")) {
                  ...
                  a.FE.KEYCODE.ARROW_UP == f
                    ? (l = Math.max(0, l - 1))
                    : a.FE.KEYCODE.ARROW_DOWN == f
                      ? (l = Math.min(b.opts.tableInsertMaxSize - 1, l + 1))
                      : a.FE.KEYCODE.ARROW_LEFT == f
                        ? (k = Math.max(0, k - 1))
                        : a.FE.KEYCODE.ARROW_RIGHT == f &&
                          (k = Math.min(b.opts.tableInsertMaxSize - 1, k + 1));
                  var m = l * j + k,
                    n = a(g.get(m));
      ...
      function m() {
        for (
          var a = '<div class="fr-table-colors">', c = 0;
          c < b.opts.tableColors.length;
          c++
        )
          0 !== c && c % b.opts.tableColorsStep == 0 && (a += "<br>"),
            "REMOVE" != b.opts.tableColors[c]
              ...
              : (a +=
                  ...
                  b.language.translate("Clear Formatting") +
                  '">' +
                  b.icon.create("tableColorRemove") +
                  '<span class="fr-sr-only">' +
                  b.language.translate("Clear Formatting") +
                  "</span></span>");
        return (a += "</div>");
      ...
      function p(c, d) {
        var e,
          f,
          g = '<table style="width: 100%;" class="fr-inserted-table"><tbody>',
          h = 100 / d;
        for (e = 0; e < c; e++) {
          for (g += "<tr>", f = 0; f < d; f++)
      ...
      function t(c) {
        ...
        if (e.length > 0) {
          ...
          for (f = 0; f < i[g].length; f++)
            if (
              ("below" == c && g < i.length - 1 && i[g][f] == i[g + 1][f]) ||
              ("above" == c && g > 0 && i[g][f] == i[g - 1][f])
            ) {
          ...
          (k += "</tr>"),
            (h = a(
              b.$el.find("th.fr-selected-cell").length > 0 && "below" == c
                ? e.find("tbody").not(e.find("table tbody"))
                : e
                    .find("tr")
                    .not(e.find("table tr"))
                    .get(g)
            ...
            "below" == c
              ? "TBODY" == h.prop("tagName") ? h.prepend(k) : h.after(k)
              : "above" == c &&
                (h.before(k), b.popups.isVisible("table.edit") && d());
        }
      }
      function u() {
        var c = ta();
                ...
                if (
                  ...
                  (n =
                    e.find("th").length > 0
                      ...
                      : '<td style="width: ' + k.toFixed(4) + '%;"><br></td>'),
                    -1 == d
                      ? e.prepend(n)
                      : null == d
                        ? e.append(n)
              ...
              c.find("th, td").each(function() {
                (f = a(this)),
                  f.hasClass("fr-selected-cell") ||
                    f.data("old-width", f.outerWidth() / c.outerWidth() * 100);
              }),
                e = h.max_j;
              e >= h.min_j;
              e--
                ...
                if (0 === d || g[d][e] != g[d - 1][e])
                  if (
                    ...
                    1 == k ? f.removeAttr("colspan") : f.attr("colspan", k),
                      f.css(
                        "width",
                        ((f.data("old-width") - ka(e, g)) * j / i).toFixed(4) +
                          "%"
                      ),
      ...
      function x(a, b, c) {
        ...
        for (b = Math.min(b, j[0].length - 1), e = a; e <= b; e++)
          if (
            !(e > a && j[0][e] == j[0][e - 1]) &&
            (g = parseInt(j[0][e].getAttribute("colspan"), 10) || 1) > 1 &&
            j[0][e] == j[0][e + 1]
          )
            for (i = g - 1, d = 1; d < j.length; d++)
              if (j[d][e] != j[d - 1][e]) {
                for (f = e; f < e + g; f++)
                  if (
                    (h = parseInt(j[d][f].getAttribute("colspan"), 10) || 1) >
                      1 &&
                    j[d][f] == j[d][f + 1]
                  )
                    (i = Math.min(i, h - 1)), (f += i);
      ...
      function y(a, b, c) {
        ...
        for (b = Math.min(b, j.length - 1), d = a; d <= b; d++)
          if (
            !(d > a && j[d][0] == j[d - 1][0]) &&
            (g = parseInt(j[d][0].getAttribute("rowspan"), 10) || 1) > 1 &&
            j[d][0] == j[d + 1][0]
          )
            for (i = g - 1, e = 1; e < j[0].length; e++)
              if (j[d][e] != j[d][e - 1]) {
                for (f = d; f < d + g; f++)
                  if (
                    (h = parseInt(j[f][e].getAttribute("rowspan"), 10) || 1) >
                      1 &&
                    j[f][e] == j[f + 1][e]
                  )
                    (i = Math.min(i, h - 1)), (f += i);
      ...
      function z(a, b, c, d, e, f, g) {
        ...
        for (h = d; h <= e; h++)
          for (i = f; i <= g; i++)
            (h > d && a[h][i] == a[h - 1][i]) ||
              (i > f && a[h][i] == a[h][i - 1]) ||
              ((j = parseInt(a[h][i].getAttribute(c), 10) || 1) > 1 &&
                (j - b > 1
                  ? a[h][i].setAttribute(c, j - b)
                  : a[h][i].removeAttribute(c)));
      }
      ...
      function B() {
        if (
          ...
          for (
            i.css("width", (n / l.outerWidth() * 100).toFixed(4) + "%"),
      ...
      function C() {
        if (1 == sa().length) {
          ...
          if (f > 1) {
            ...
            for (
              var k = h.row + j, l = 0 === h.col ? h.col : h.col - 1;
              l >= 0 &&
            ...
            for (m = 0; m < g[0].length; m++)
              if (0 === m || g[h.row][m] != g[h.row][m - 1]) {
                var o = a(g[h.row][m]);
                o.is(c) ||
                  o.attr("rowspan", (parseInt(o.attr("rowspan"), 10) || 1) + 1);
              }
            d.after(n);
          }
      ...
      function L() {
        b.el.querySelector(".fr-cell-fixed") &&
          b.el
            .querySelector(".fr-cell-fixed")
            .classList.remove("fr-cell-fixed"),
          b.el.querySelector(".fr-cell-handler") &&
            b.el
      ...
      function P(b, c, d, e, f) {
        ...
        return k == b && l == c && m == d && n == e
          ? { min_i: b, max_i: c, min_j: d, max_j: e }
          : P(k, l, m, n, f);
      }
      function Q(b) {
        var c = O(b),
      ...
      function V(c) {
        if (
          (za ||
            ...
            (sa().length > 0 && b.toolbar.enable(), M()),
          !(1 != c.which || (1 == c.which && b.helpers.isMac() && c.ctrlKey)))
        ) {
          if (((Aa = !1), za)) {
            za = !1;
            S(c) || 1 != sa().length
              ? sa().length > 0 && (b.selection.isCollapsed() ? d() : M())
              : M();
          }
          if (Da) {
            (Da = !1),
            ...
            b.opts.iframe && (e -= b.$iframe.offset().left),
        ...
        if (!0 === za) {
          if (
            ...
            if (
              ...
              return void R(Ba, c.currentTarget);
            if (
      ...
      function Y(a, c, d, e) {
        for (
          ...
          "TH" != g.tagName &&
          ("up" == e
            ? (f = g.previousElementSibling)
            : "down" == e && (f = g.nextElementSibling),
          !f);

        )
          g = g.parentNode;
        "TD" == g.tagName || "TH" == g.tagName
          ? X(g, e)
          : f &&
            ("up" == e && b.selection.setAtEnd(f),
            "down" == e && b.selection.setAtStart(f));
      }
      function Z(a, c, d) {
        a.row > 0
          ? b.selection.setAtEnd(d[a.row - 1][a.col])
          : Y(a, c, d, "up");
      }
      function $(a, c, d) {
        var e = parseInt(d[a.row][a.col].getAttribute("rowspan"), 10) || 1;
        a.row < d.length - e
          ? b.selection.setAtStart(d[a.row + e][a.col])
          : Y(a, c, d, "down");
      }
      function _(c) {
        var d = c.which,
        ...
        if (e.length && ((e = e[0]), "TD" == e.tagName || "TH" == e.tagName)) {
          ...
          if (
            f &&
            "TABLE" == f.tagName &&
            (a.FE.KEYCODE.ARROW_LEFT == d ||
              a.FE.KEYCODE.ARROW_UP == d ||
              a.FE.KEYCODE.ARROW_RIGHT == d ||
              a.FE.KEYCODE.ARROW_DOWN == d) &&
            (sa().length > 0 && T(),
            b.browser.webkit &&
              (a.FE.KEYCODE.ARROW_UP == d || a.FE.KEYCODE.ARROW_DOWN == d))
          ) {
            var g = b.selection.ranges(0).startContainer;
            if (
              g.nodeType == Node.TEXT_NODE &&
              ((a.FE.KEYCODE.ARROW_UP == d && g.previousSibling) ||
                (a.FE.KEYCODE.ARROW_DOWN == d && g.nextSibling))
            )
              return;
            c.preventDefault(), c.stopPropagation();
            var h = I(a(f)),
            ...
            return (
              a.FE.KEYCODE.ARROW_UP == d
                ? Z(i, f, h)
                : a.FE.KEYCODE.ARROW_DOWN == d && $(i, f, h),
              b.selection.restore(),
              !1
            );
          }
      ...
      function aa() {
        b.shared.$table_resizer ||
          ...
          b.events.$on(xa, "mousedown", function(a) {
            return (
              !b.core.sameInstance(xa) ||
              (sa().length > 0 && T(),
              1 == a.which
                ? (b.selection.save(),
                  (Da = !0),
                  xa.addClass("fr-moving"),
                  N(),
                  b.edit.off(),
          ...
          b.events.$on(xa, "mousemove", function(a) {
            ...
            Da &&
              (b.opts.iframe && (a.pageX -= b.$iframe.offset().left), ma(a));
          }),
          b.events.on(
            "shared.destroy",
            function() {
      ...
      function da(c, d) {
        ...
        if (
          (d &&
            ...
            (e.closest("td").length > 0
              ? (d = e.closest("td"))
              : e.closest("th").length > 0 && (d = e.closest("th"))),
          !d || ("TD" != d.tagName && "TH" != d.tagName))
        )
          xa &&
            e.get(0) != xa.get(0) &&
            e.parent().get(0) != xa.get(0) &&
            b.core.sameInstance(xa) &&
            ba();
        else {
          ...
          if (
            ...
            "rtl" != b.opts.direction
              ? c.pageX - h <= b.opts.tableResizerOffset
                ? ((l = h),
                  p.col > 0
                    ? ((m = h - ka(p.col - 1, o) + b.opts.tableResizingLimit),
                      (n = h + ka(p.col, o) - b.opts.tableResizingLimit),
                      (j = p.col - 1),
                      (k = p.col))
                    : ((j = null),
                      (k = 0),
                ...
                : i - c.pageX <= b.opts.tableResizerOffset &&
                  ...
                  q.col < o[q.row].length && o[q.row][q.col + 1]
                    ? ((m = i - ka(q.col, o) + b.opts.tableResizingLimit),
                      (n = i + ka(q.col + 1, o) - b.opts.tableResizingLimit),
                      (j = q.col),
                      (k = q.col + 1))
                    : ((j = q.col),
                      (k = null),
              ...
              : i - c.pageX <= b.opts.tableResizerOffset
                ? ((l = i),
                  p.col > 0
                    ? ((m = i - ka(p.col, o) + b.opts.tableResizingLimit),
                      (n = i + ka(p.col - 1, o) - b.opts.tableResizingLimit),
                      (j = p.col),
                      (k = p.col - 1))
                    : ((j = null),
                      (k = 0),
                ...
                : c.pageX - h <= b.opts.tableResizerOffset &&
                  ((l = h),
                  q.col < o[q.row].length && o[q.row][q.col + 1]
                    ? ((m = h - ka(q.col + 1, o) + b.opts.tableResizingLimit),
                      (n = h + ka(q.col, o) - b.opts.tableResizingLimit),
                      (j = q.col + 1),
                      (k = q.col))
                    : ((j = q.col),
                      (k = null),
            ...
            b.opts.iframe &&
              ((t += b.$iframe.offset().left - b.helpers.scrollLeft()),
      ...
      function ea(c, d) {
        ...
        var e = a(d),
          ...
          i = 0;
        b.opts.iframe &&
          ((h += b.$iframe.offset().left - b.helpers.scrollLeft()),
        ...
        f.find("th, td").each(function() {
          ...
          g < c.offset().left + c.outerWidth() / 2
            ? ((j = parseInt(ya.find("a").css("width"), 10)),
      ...
      function fa(c, d) {
        ...
        var e = a(d),
          ...
          h = 0;
        b.opts.iframe &&
          ((g += b.$iframe.offset().left - b.helpers.scrollLeft()),
          (h += b.$iframe.offset().top - b.helpers.scrollTop()));
        var i;
        e.find("tr").each(function() {
          var c = a(this);
          return c.offset().top <= f && f < c.offset().top + c.outerHeight() / 2
            ? ((i = parseInt(ya.find("a").css("width"), 10)),
      ...
      function ga(c, d) {
        if (0 === sa().length) {
          ...
          if (
            d &&
            ("HTML" == d.tagName || "BODY" == d.tagName || b.node.isElement(d))
          )
            for (e = 1; e <= b.opts.tableInsertHelperOffset; e++) {
              ...
              if (
                ...
                return ea(c, a(f).closest("table")), !0;
              if (
              ...
              if (
                ...
                return fa(c, a(g).closest("table")), !0;
            }
      ...
      function ja() {
        ...
        if (c !== d) {
          ...
          if ((b.undo.canDo() || b.undo.saveStep(), null !== e && null !== f)) {
            ...
            ("rtl" == b.opts.direction && 0 === f) ||
            ("rtl" != b.opts.direction && 0 !== f)
              ? ((r = (h + d - c) / h * t),
                g.css(
                  "margin-right",
                  "calc(100% - " +
                    Math.round(r).toFixed(4) +
                    "% - " +
                    Math.round(u).toFixed(4) +
                    "%)"
                ))
              : (("rtl" == b.opts.direction && 0 !== f) ||
                  ("rtl" != b.opts.direction && 0 === f)) &&
      ...
      function ma(a) {
        if ((sa().length > 1 && Aa && N(), !1 === Aa && !1 === za && !1 === Da))
          Ca && clearTimeout(Ca),
            (b.edit.isDisabled() && !b.popups.isVisible("table.edit")) ||
              (Ca = setTimeout(ha, 30, a));
        else if (Da) {
          ...
          var d = xa.data("max-left"),
            e = xa.data("max-right");
          c >= d && c <= e
            ? xa.css("left", c - b.opts.tableResizerOffset)
            : c < d &&
              parseFloat(xa.css("left"), 10) > d - b.opts.tableResizerOffset
              ? xa.css("left", d - b.opts.tableResizerOffset)
              : c > e &&
                parseFloat(xa.css("left"), 10) <
                  e - b.opts.tableResizerOffset &&
                xa.css("left", e - b.opts.tableResizerOffset);
        } else Aa && ca();
      }
      function na(c) {
        ...
        if (c.which == a.FE.KEYCODE.TAB) {
          ...
          if (sa().length > 0) d = b.$el.find(".fr-selected-cell:last");
            ...
            "TD" == e.tagName || "TH" == e.tagName
              ? (d = a(e))
              : e != b.el &&
                (a(e).parentsUntil(b.$el, "td").length > 0
                  ? (d = a(e).parents("td:first"))
                  : a(e).parentsUntil(b.$el, "th").length > 0 &&
                    (d = a(e).parents("th:first")));
          }
          if (d)
            return (
              c.preventDefault(),
              a(b.selection.element()).parents("ol, ul").length > 0 ||
                (T(),
                c.shiftKey
                  ? d.prev().length > 0
                    ? na(d.prev())
                    : d.closest("tr").length > 0 &&
                      d.closest("tr").prev().length > 0
                      ? na(
                          d
                            .closest("tr")
                            .prev()
                      ...
                      : d.closest("tbody").length > 0 &&
                        d.closest("table").find("thead tr").length > 0 &&
                        na(d.closest("table").find("thead tr th:last"))
                  : d.next().length > 0
                    ? na(d.next())
                    : d.closest("tr").length > 0 &&
                      d.closest("tr").next().length > 0
                      ? na(
                          d
                            .closest("tr")
                            .next()
                      ...
                      : d.closest("thead").length > 0 &&
                        d.closest("table").find("tbody tr").length > 0
                        ? na(d.closest("table").find("tbody tr td:first"))
                        : (d.addClass("fr-selected-cell"),
                          t("below"),
                          M(),
                          na(
                            d
      ...
      function ta() {
        ...
        if (c.length) {
          for (
            var d = c[0];
            d && "TABLE" != d.tagName && d.parentNode != b.el;
            ...
            ("TD" == f.tagName || "TH" == f.tagName
              ...
              : a(f).closest("td").length > 0
                ? (e = a(f)
                    .closest("td")
                    .get(0))
                : a(f).closest("th").length > 0 &&
                  (e = a(f)
                    .closest("th")
                    .get(0)),
            e)
          )
            return c.preventDefault(), R(e, e), d(), !1;
        }
      }
      function va(c) {
        var d = sa();
        if (d.length > 0) {
          ...
          1 == d.length
            ? ((e = d[0]), (f = e))
            : ((e = b.el.querySelector(".fr-cell-fixed")),
        ...
        if (!b.helpers.isMobile()) {
          ...
          b.events.on("html.beforeGet", function() {
            ...
            b.events.on("html.afterGet", function() {
              for (var a = 0; a < c.length; a++)
                c[a].className =
                  (c[a].className ? c[a].className.trim() + " " : "") +
                  "fr-selected-cell";
              c = [];
            }),
            g(!0),
    ...
    (a.FE.PLUGINS.url = function(b) {
      function c(c, d, e) {
        for (var f = ""; e.length && "." == e[e.length - 1]; )
          (f += "."), (e = e.substring(0, e.length - 1));
        var g = e;
        if (b.opts.linkConvertEmailAddress) {
          a.FE.MAIL_REGEX.test(g) &&
            !/^mailto:.*/i.test(g) &&
            (g = "mailto:" + g);
        }
        return (
          /^((http|https|ftp|ftps|mailto|tel|sms|notes|data)\:)/i.test(g) ||
            (g = "//" + g),
          (d || "") +
            "<a" +
            (b.opts.linkAlwaysBlank ? ' target="_blank"' : "") +
            (j ? ' rel="' + j + '"' : "") +
            ' href="' +
            g +
            '">' +
      ...
      function e(a) {
        return (
          b.opts.linkAlwaysNoFollow && (j = "nofollow"),
          b.opts.linkAlwaysBlank &&
            (j ? (j += " noopener noreferrer") : (j = "noopener noreferrer")),
          a.replace(d(), c)
        );
      }
      function f(a) {
        return (
          !!a &&
          ("A" === a.tagName ||
            (!(!a.parentNode || a.parentNode == b.el) && f(a.parentNode)))
        );
      }
      function g(a) {
        var b = a.split(" ");
        ...
        b.events.on("paste.afterCleanup", function(c) {
          ...
          b.events.on(
            ...
            function(c) {
              ...
              !b.selection.isCollapsed() ||
                (d != a.FE.KEYCODE.ENTER &&
                  d != a.FE.KEYCODE.SPACE &&
                  d != a.FE.KEYCODE.PERIOD) ||
                h();
            },
            !0
          );
    ...
    (a.FE.PLUGINS.video = function(b) {
      function c() {
        ...
        a
          .find(".fr-video-by-url-layer input")
          .val("")
          .trigger("change");
      ...
      function f(a) {
        if (a)
          return (
            b.popups.onRefresh("video.insert", c),
        ...
        h >= 0 &&
          ...
          (f =
            ...
            b.id +
            '" type="text" placeholder="http://" tabIndex="1" aria-required="true"></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="videoInsertByURL" tabIndex="2" role="button">' +
            b.language.translate("Insert") +
            "</button></div></div>"));
        var j = "";
        i >= 0 &&
        ...
        g >= 0 &&
          ...
          (k =
            ...
            b.opts.videoAllowedTypes.join(", video/").toLowerCase() +
          ...
          if (e) {
            ...
            e.data("fr-replaced", !1),
              b.$wp
                ...
                : (c = e);
            for (
              var j = c.find("video").get(0).attributes, k = 0;
              k < j.length;
              k++
            ) {
              var m = j[k];
              0 === m.nodeName.indexOf("data-") &&
                c.find("video").removeAttr(m.nodeName);
            }
            if (void 0 !== d)
              for (g in d)
                d.hasOwnProperty(g) &&
                  "link" != g &&
                  c.find("video").attr("data-" + g, d[g]);
      ...
      function o(a) {
        ...
        if (
          ...
          if (
            (b.events.focus(),
            b.$el.find("video.fr-error").length &&
              (b.$el
                .find("video.fr-error")
                .parent()
                .remove(),
      ...
      function r(c) {
        ...
        if (b.helpers.isURL(c))
          for (var e = 0; e < a.FE.VIDEO_PROVIDERS.length; e++) {
            ...
            if (
              f.test_regex.test(c) &&
              new RegExp(b.opts.videoAllowedProviders.join("|")).test(
                f.provider
              )
            ) {
      ...
      function u(a) {
        try {
          if (!1 === b.events.trigger("video.uploaded", [a], !0))
            return b.edit.on(), !1;
          var c = JSON.parse(a);
          return c.content.picId ? c : (S(sa, a), !1);
        } catch (d) {
          return S(ua, a), !1;
        }
      }
        ...
        try {
          var d = a(c)
            ...
            e = a(c)
              .find("Key")
              .text();
          return !1 === b.events.trigger("video.uploadedToS3", [d, e, c], !0)
            ? (b.edit.on(), !1)
            : d;
        } catch (f) {
          return S(ua, c), !1;
      ...
      function A(c, d, e) {
        ...
        var val =  (
          b.node.isLastSibling(j) &&
            j.parent().hasClass("fr-deletable") &&
            j.insertAfter(j.parent()),
          j.replaceWith(i),
          b.html.wrap(),
          b.selection.clear(),
          i.find("video").get(0).readyState >
            i.find("video").get(0).HAVE_FUTURE_DATA || b.helpers.isIOS()
            ? e.call(i.find("video").get(0))
            : i.find("video").on("canplaythrough load", e),
          i
        );
        b.opts.videoGetUrl(c, 1, val.find('video'));
        return val;
      }
      function B(c) {
        ...
        var d =
          ...
          e =
            c.pageY ||
            (c.originalEvent.touches ? c.originalEvent.touches[0].pageY : null);
        if (!d || !e) return !1;
        if ("mousedown" == c.type) {
          var f = b.$oel.get(0),
            g = f.ownerDocument,
          ...
          i &&
            h.frameElement &&
            ((d +=
              b.helpers.getPX(a(h.frameElement).offset().left) +
              h.frameElement.clientLeft),
            (e =
              c.clientY +
              b.helpers.getPX(a(h.frameElement).offset().top) +
              h.frameElement.clientTop));
        }
        b.undo.canDo() || b.undo.saveStep(),
          (pa = a(this)),
          pa.data("start-x", d),
          ...
          b.events.on("keydown", function(c) {
            if (ra) {
              ...
              (h !== e || c.timeStamp - f > 200) && (d = 1),
                ...
                g &&
                !c.altKey
                  ? (d = F.call(this, c, 1, 1, d))
                  : (h == a.FE.KEYCODE.HYPHEN ||
                      (b.browser.mozilla && h == a.FE.KEYCODE.FF_HYPHEN)) &&
                    g &&
                    !c.altKey &&
                    (d = F.call(this, c, 2, -1, d)),
                (e = h),
                (f = c.timeStamp);
            }
          }),
      ...
      function H() {
        ...
        if (ya)
          for (c = 0; c < ya.length; c++)
            e.indexOf(ya[c].getAttribute("src")) < 0 &&
              b.events.trigger("video.removed", [a(ya[c])]);
        ya = d;
      }
      function I() {
        ...
        qa
          .css(
            "top",
            (b.opts.iframe
              ? a.offset().top - 1 + b.$iframe.position().top
              : a.offset().top - b.$wp.offset().top - 1) + b.$wp.scrollTop()
          )
          .css(
            "left",
            (b.opts.iframe
              ? a.offset().left - 1
              : a.offset().left - b.$wp.offset().left - 1) + b.$wp.scrollLeft()
          )
        ...
        if (d && d.files && d.files.length) {
          ...
          if (e && e.type && -1 !== e.type.indexOf("video")) {
            ...
            return (
              ...
              n(),
              b.opts.videoAllowedTypes.indexOf(
                e.type.replace(/video\//g, "")
              ) >= 0
                ? P(d.files)
                : S(wa),
              c.preventDefault(),
      ...
      function P(a) {
        if (void 0 !== a && a.length > 0) {
          ...
          window.editorFileSuffix = c.name.split('.')[1];
          if (
            b.opts.videoAllowedTypes.indexOf(c.type.replace(/video\//g, "")) < 0
          )
            return S(wa), !1;
          var d;
          if (
            ...
            if (!1 !== b.opts.videoUploadToS3) {
              d.append(
                "key",
                b.opts.videoUploadToS3.keyStart +
                  new Date().getTime() +
                  "-" +
                  (c.name || "untitled")
              ),
              ...
              for (e in b.opts.videoUploadToS3.params)
                b.opts.videoUploadToS3.params.hasOwnProperty(e) &&
                  d.append(e, b.opts.videoUploadToS3.params[e]);
            }
            for (e in b.opts.videoUploadParams)
              b.opts.videoUploadParams.hasOwnProperty(e) &&
                d.append(e, b.opts.videoUploadParams[e]);
            d.append(b.opts.videoUploadParam, c);
            var f = b.opts.videoUploadURL;
            b.opts.videoUploadToS3 &&
              (f = b.opts.videoUploadToS3.uploadURL
                ? b.opts.videoUploadToS3.uploadURL
                : "https://" +
                  b.opts.videoUploadToS3.region +
                  ".amazonaws.com/" +
                  b.opts.videoUploadToS3.bucket);
            ...
            h &&
              h.off("abortUpload").on("abortUpload", function() {
      ...
      function S(a, c) {
        b.edit.on(),
          ...
          b.events.trigger("video.error", [{ code: a, message: xa[a] }, c]);
      }
      function T() {
        var a = "";
        if (b.opts.videoEditButtons.length > 0) {
          ...
          return (
            b.events.$on(b.$wp, "scroll.video-edit", function() {
              ra &&
                b.popups.isVisible("video.edit") &&
                (b.events.disableBlur(), t(ra));
            }),
            d
          );
        }
      ...
      function ca() {
        var a = b.popups.get("video.insert");
        a || (a = f()),
          b.popups.isVisible("video.insert") ||
            (o(),
            b.popups.refresh("video.insert"),
            b.popups.setContainer("video.insert", b.$sc));
      ...
      function fa(a, c, d) {
        !b.opts.htmlUntouched && b.opts.useClasses
          ? (a.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"),
            a.addClass("fr-fv" + d[0] + " fr-dv" + c[0]))
          : "inline" == c
            ? (a.css({ display: "inline-block" }),
              "center" == d
                ...
                : "left" == d
                  ? a.css({ float: "left" })
                  : a.css({ float: "right" }))
            : (a.css({ display: "block", clear: "both" }),
              "left" == d
                ? a.css({ textAlign: "left" })
                : "right" == d
                  ? a.css({ textAlign: "right" })
                  : a.css({ textAlign: "center" }));
      }
      function ga(a) {
        a.hasClass("fr-dvi") ||
          a.hasClass("fr-dvb") ||
          (a.addClass("fr-fv" + X(a)[0]), a.addClass("fr-dv" + _(a)[0]));
      }
      function ha(a) {
        fa(
          a,
          a.hasClass("fr-dvb")
            ? "block"
            : a.hasClass("fr-dvi") ? "inline" : null,
          a.hasClass("fr-fvl") ? "left" : a.hasClass("fr-fvr") ? "right" : X(a)
        ),
          ...
          b.$el
            ...
            .filter(function() {
              if (
                ...
                return !1;
              for (
                var c = a(this).attr("src"), d = 0;
                d < a.FE.VIDEO_PROVIDERS.length;
                d++
              ) {
            ...
            .wrap('<span class="fr-video" contenteditable="false"></span>');
        for (
          var c = b.$el.find("span.fr-video, video"), d = 0;
          d < c.length;
          d++
        ) {
          var e = a(c[d]);
          !b.opts.htmlUntouched && b.opts.useClasses
            ? (ga(e),
              b.opts.videoTextNear ||
                e.removeClass("fr-dvi").addClass("fr-dvb"))
            : b.opts.htmlUntouched || b.opts.useClasses || ha(e);
        }
          ...
          b.events.on(
            ...
            function(c) {
              ...
              (d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.DELETE)
                ? ra && d == a.FE.KEYCODE.ESC
                  ? (K(!0), c.preventDefault(), !1)
                  : ra && d != a.FE.KEYCODE.F10 && !b.keys.isBrowserAction(c)
                    ? (c.preventDefault(), !1)
                    : void 0
                : (c.preventDefault(), da(), !1);
            },
            !0
          ),
          b.events.on(
      ...
      function la() {
        ra
          ? (b.events.disableBlur(), ra.trigger("click"))
          : (b.events.disableBlur(),
            b.selection.restore(),
            b.events.enableBlur(),
            b.popups.hide("video.insert"),
      ...
      var oa,
        ...
        wa = 6,
        xa = {};
      (xa[1] = "Video cannot be loaded from the passed link."),
        (xa[sa] = "No link in upload response."),
        (xa[ta] = "Error during file upload."),
        (xa[ua] = "Parsing response failed."),
        (xa[va] = "File is too large."),
        (xa[wa] = "Video file type is invalid."),
        (xa[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.");
      var ya, za;
      return (
        (b.shared.vid_exit_flag = !1),
        {
        ...
        for (var d in c)
          c.hasOwnProperty(d) &&
            (b +=
              ...
              this.language.translate(c[d]) +
              '">' +
              this.icon.create("video-align-" + d) +
              '<span class="fr-sr-only">' +
              this.language.translate(c[d]) +
              "</span></a></li>");
        return (b += "</ul>");
    ...
    (a.FE.PLUGINS.wordPaste = function(b) {
      ...
      function d() {
        ...
        return (
          ...
          (a +=
            ...
            b.language.translate("Clean") +
            '</button> <button class="fr-keep-word fr-command">' +
            b.language.translate("Keep") +
            "</button></div>"),
          (a += "</div>")
        );
      }
      function e() {
        if (!z) {
          var c =
              ...
              b.language.translate("Word Paste Detected") +
              "</h4>",
            e = d(),
            ...
            (c = c.nextSibling),
              ...
              !c.parentNode
                ? d.previousSibling ||
                  ...
                  c.parentNode ||
                  (e
                    ? (c = e.nextSibling ? e.nextSibling.nextSibling : null)
                    : a.firstChild && (c = a.firstChild.nextSibling))
                : (c = e ? e.nextSibling : a.firstChild);
          }
      }
      function j(a) {
        if (
          !a.getAttribute("style") ||
          !/mso-list:[\s]*l/gi.test(a.getAttribute("style").replace(/\n/gi, ""))
        )
          return !1;
        try {
      ...
      function l(a, b) {
        ...
        i(c, function(a) {
          return (
            a.nodeType == Node.ELEMENT_NODE &&
              ("mso-list:Ignore" == a.getAttribute("style") &&
                a.parentNode.removeChild(a),
              v(a, b)),
            !0
          );
      ...
      function m(a, b) {
        ...
        a.firstElementChild &&
          ...
          a.firstElementChild.firstElementChild.firstChild &&
          !(d =
            d ||
            c.test(
              a.firstElementChild.firstElementChild.firstChild.data || ""
            )) &&
          a.firstElementChild.firstElementChild.firstElementChild &&
          a.firstElementChild.firstElementChild.firstElementChild.firstChild &&
          (d =
            d ||
            c.test(
              a.firstElementChild.firstElementChild.firstElementChild.firstChild
      ...
      function n(a, b) {
        for (
          var c = document.createElement(b), d = 0;
      ...
      function o(c, d) {
        ...
        for (var e = c.firstElementChild, f = 0, g = !1, i = null; e; ) {
          e.firstElementChild &&
            -1 != e.firstElementChild.tagName.indexOf("W:") &&
            (e.innerHTML = e.firstElementChild.innerHTML),
            (i = e.getAttribute("width")),
            i || g || (g = !0),
            (f += parseInt(i, 10)),
            (!e.firstChild ||
              (e.firstChild && e.firstChild.data == a.FE.UNICODE_NBSP)) &&
              (e.firstChild && h(e.firstChild), (e.innerHTML = "<br>"));
          for (var k = e.firstElementChild, l = 1 == e.children.length; k; )
            "P" != k.tagName || j(k) || (l && p(k)), (k = k.nextElementSibling);
          if (d) {
        ...
        for (e = c.firstElementChild; e; )
          (i = e.getAttribute("width")),
            g
              ...
              : e.setAttribute("width", 100 * parseInt(i, 10) / f + "%"),
            (e = e.nextElementSibling);
      }
      function p(a) {
        var b = a.parentNode,
        ...
        c &&
          (b && "TD" == b.tagName
            ? (b.setAttribute(
                "style",
                b.getAttribute("style") + "text-align:" + c + ";"
              ),
              a.removeAttribute("align"))
            : ((a.style["text-align"] = c), a.removeAttribute("align")));
      }
      function q(a) {
        return a.replace(/\n|\r|\n\r|&quot;/g, "");
      }
          ...
          if (d) {
            ...
            if (!g || 2 == g.length) {
              ...
              if (!(h && h.length < 2)) {
                var i = null;
                if (
                  (-1 != h[0].indexOf("pngblip")
                    ? (i = "image/png")
                    : -1 != h[0].indexOf("jpegblip") && (i = "image/jpeg"),
                  i)
                ) {
                  var j = h[1].split("}");
                  if (!(j && j.length < 2)) {
                    var k;
                    if (j.length > 2 && -1 != j[0].indexOf("blipuid"))
                      k = j[1].split(" ");
                    else {
                    ...
                    "IMG" === b.tagName
                      ? ((b.src = n),
                        b.setAttribute("data-fr-image-pasted", !0))
                      : a(b.parentNode)
                          .before(
                            '<img data-fr-image-pasted="true" src="' +
                              n +
                              '" style="' +
                              b.parentNode.getAttribute("style") +
                              '">'
                          )
                          .remove();
                  }
      ...
      function v(b, c) {
        ...
        if (
          (b.firstElementChild &&
            ("I" == b.firstElementChild.tagName
              ? n(b.firstElementChild, "em")
              : "B" == b.firstElementChild.tagName &&
                n(b.firstElementChild, "strong")),
          -1 !=
            ["SCRIPT", "APPLET", "EMBED", "NOFRAMES", "NOSCRIPT"].indexOf(d))
        )
          return h(b), !1;
        "O:P" == d &&
          "&nbsp;" == b.innerHTML &&
          (b.innerHTML = a.FE.INVISIBLE_SPACE);
        var f = -1,
          g = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"];
        for (f = 0; f < g.length; f++)
          if (-1 != d.indexOf(g[f]))
            return b.innerHTML
              ? ((b.outerHTML = b.innerHTML), h(b), !1)
              : (h(b), !1);
        if ("TD" != d) {
        ...
        if (
          ("TR" == d && o(b, c),
          "A" == d &&
            !b.attributes.getNamedItem("href") &&
            b.innerHTML &&
      ...
      function y(c, d) {
        (c = c.replace(
          /[.\s\S\w\W<>]*(<html[^>]*>[.\s\S\w\W<>]*<\/html>)[.\s\S\w\W<>]*/gi,
          "$1"
        )),
          x(c);
        var e = new DOMParser(),
        ...
        i(k, function(b) {
          if (b.nodeType == Node.TEXT_NODE && /\n|\u00a0/.test(b.data)) {
            if (!/\S/.test(b.data))
              return b.data == a.FE.UNICODE_NBSP
                ? ((b.data = "\u200b"), !0)
                : (h(b), !1);
          ...
          i(k, function(a) {
            return (
              a.nodeType != Node.ELEMENT_NODE ||
                ("V:IMAGEDATA" != a.tagName && "IMG" != a.tagName) ||
                u(a, d),
              !0
            );
          }),
            ...
            if (a.nodeType == Node.ELEMENT_NODE) {
              if (j(a)) {
                var b = a.parentNode,
                  ...
                  e = null;
                return (
                  (e = c ? c.nextSibling : b.firstChild),
          ...
          i(k, function(a) {
            if (a.nodeType == Node.ELEMENT_NODE) {
              ...
              if (!a.innerHTML && -1 == ["BR", "IMG"].indexOf(b)) {
                for (var c = a.parentNode; c && (h(a), (a = c), !a.innerHTML); )
                  c = a.parentNode;
                return !1;
              }
              s(a);
        ...
        return (
          (b.opts.htmlAllowedStyleProps = b.opts.wordAllowedStyleProps),
          (n = b.clean.html(
            n,
            b.opts.wordDeniedTags,
            b.opts.wordDeniedAttrs,
            !1
          )),
