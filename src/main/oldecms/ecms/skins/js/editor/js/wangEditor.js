...
(function (factory) {
    ...
    var _e = function (fn) {
        ...
        var oDiv=document.getElementById("editor-container");
    };
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        editor.xhrUploadImg = function (opt) {
            ...
            //文件名处理
            var filename = Utils.newGUID() + "." + fileExt;
            ...
            formData.append("content0", convertBase64UrlToBlob(base64, fileType));//核心切割file文件，下面详细解释
