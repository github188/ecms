...
function setup_sidebar_menu()
{
	...
	{
		var $items_with_subs = public_vars.$sidebarMenu.find('li'),
			toggle_others = public_vars.$sidebarMenu.hasClass('toggle-others');

		var $allLi= public_vars.$sidebarMenu.find('li');
		var $chirenli=public_vars.$sidebarMenu.children('li');
		$chirenli.each(function(){
        ...
        $(window).unbind('scroll')
			   ...
			   $(this).siblings().find("li").removeClass("active");
			    ...
			    if(typeof $(this).children('a').attr('url') != undefined){
